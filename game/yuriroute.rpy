label yuriroute:
    ...
    mc "Hey, what's up?"
    show yuri 3n zorder 2 at h11
    "She jumps, startled."
    "Once she sees it's just me, she calms down."
    y 1n "Oh!"
    y 1l "I-I didn't notice you there, [player]."
    y 2l "Sorry, you startled me."
    ...
    y 3b "I-I don't mind putting some time aside to speak with you, [player]."
    mc "That's a relief."
    ...
    n "Yeah, you're always late to it."
    show monika at t31
    show sayori zorder 1 at thide
    hide sayori
    show natsuki at t32
    show yuri 2l zorder 4 at f33
    y "I don't believe that's what she was referring to, Natsuki."
    show monika at t31
    show natsuki at f32
    show yuri at t33
    ...
    scene bg house_morning
    with wipeleft_scene
    show sayori m3a zorder 2 at t11
    ...
    s m1x "It was clear from when you first met that you liked her~"
    mc "Am I... really that obvious?"
    s m1r "Yep!"
    s m2i "Don't worry, though!"
    s m1d "It worked out in the end, didn't it?"
    ...
    hide natsuki
    hide sayori
    show monika m5a zorder 1 at f11
    ...
    mc "Oh yeah, it’s right in my bookba-"
    "I cut myself off."
    ...
    menu:
        ...
        "Accept Yuri's help.":
            ...
            y 2t "Alright, well, perhaps I can still salvage the situation."
    ...
    y s3bt "Did... did you like the book, [player]?"
    menu:
        "Well..."
    ...
    y n4bd "I-I would rather have you use it anyway."
    ...
    y n2bs "Of course."
    y n2bc "I... I really did love this."
    y n2bq "Are we going to really do this every Sunday?"
    ...
    menu:
        ...
        "A Story-Driven game.":
            ...
            "She seems to think about it for a moment."
            y e1bk "Well, clearly the problem can't be resolved diplomatically."
            y e2bw "However, fighting for the good guys leaves you underpowered and basically ready for death."
            y e2bl "The villains, however..."
            "I'm almost shocked."
            ...
            y e1bt "You... you actually listened to me?"
            mc "That's what I said I would do."
            y "I didn't expect you to actually do it, though..."
            y e1bs "That... that makes me really happy, [player]."
            ...
            y e2bs "I have to thank you for this, [player]."
            y e2bq "I didn't expect tonight to go how it did, but I'm glad you convinced me."
            y e1bc "I'm glad we're dating."
            y e1bd "Everything is making me so happy right now."
    ...
    show yuri s1bn zorder 2 at t11
    ...
    mc "Sorry."
    y s1bn "Sick? Ah, [player], that isn't good."
    ...
    menu:
        ...
        "Let Yuri in":
            ...
            show yuri s2ba zorder 2 at t11
            y s2ba "Here."
            ...
            y s2bp "[player]?"
            mc "Huh? Oh, what's up?"
            y s3bo "Y-you were staring at me, is something wrong?"
            mc "Oh, I just..."
            mc "Spaced out."
            ...
            y s1bb "It actually is fun spending time with you."
    ...
    "She speaks up."
    y n2bm "It's interesting, isn't it?"
    ...
    y n3bu "There's no need to talk about it."
    y n3bs "I'm enjoying this."
    y n2bq "Just watching these snowflakes fall..."
    y n2bj "Can we just do that?"
    ...
    if YuriVar >= 3:
        ...
        y n4bb "A-are you sure?"
        y n4bd "I really d-don't want to bring it up."
        "Yuri begins to break a sweat."
        mc "Are you... nervous about something?"
        "She panics."
        y n4bc "N-no!"
        y n4bb "I'm just a bit hot!"
