...
#Start Scene 11 - Never What it Looks Like
    ...
    if ((end_dir == "YN" or end_dir == "SN") and (karma < 0) and (is_end == False)):
        $ is_end = True
        call Natsuki61
    
    if ((end_dir == "SN") and (karma >= 0 and karma < 4) and (is_end == False)):
        $ is_end = True
        call Natsuki62

    if ((end_dir == "YN") and (karma >= 0 and karma < 4) and (is_end == False)):
        $ is_end = True
        call Natsuki63
...
#Start Scene 11a - Bad Ending
    ...
    mc "Yeah, but that was before I started dating a world famous chef."
    ...
    menu:
        "We should go":
            ...
            "Natsuki cocks her head to the side a moment."
            n 5bb "...[player], do you even have each other’s numbers?"
            "I take a minute to consider this and realize that she’s right."
            "I don’t think she’d ever have a chance to get that from me."
            mc "That’s a good point. I certainly don’t have hers."
            mc "Whatever, it’s incidental."
            mc "Let’s just go find out what’s up."
        ...
        "We should stay":
            ...
            "While that casts doubt in my mind for a minute, Natsuki destroys my case outright."
            n 5bb "Maybe it’s because she doesn’t have your number?"
            n "Or at least, I assume she doesn’t..."
            mc "Oh, you’re right."
            mc "I met her through the club, and the topic never really came up."
            "Crap, I’m on the backfoot here."
            "Before I can reset my offensive, Natsuki gets that look on her face like her mind’s made up."
    ...
    "We both grab a set of warm clothes and head out on our way to the school."
    scene bg club_day
    with wipeleft_scene
    ...
    m 3d "You see, in order for a club to qualify officially in the eyes of the school, it has to have at least five members."
    ...
    mc "She doesn’t take the courtesy of whispering back."
    ...
    show natsuki 4k at f22 zorder 3
    ...
    n "And that’s justification enough for Monika to drag us all the way out here in the freezing cold for something we could have done over a fucking text chat!"
    ...
    m 2b "I mean, the only reason she left in the first place was because of Natsuki."
    m "Clearly, you can see that too, can’t you, [player]?"
    ...
    n "Is...{w=0.5} is that how you really feel?"
    ...
    show natsuki at t22 zorder 2
    mc "Natsuki, please, you’re overreacting-{nw}"
    show natsuki 42a at f22 zorder 3
    n "ou know what I’ve realized, [player], just now?"
    ...
    n 32g "Instead of taking the blame for it, you use me as a scapegoat."
    ...
    m 2d "For starters, I think we lost another member of the club."
    ...
    m 3g "I have no doubt this is a sensitive subject for her."
    m 2p "Sorry, I..."
    ...
    m 3o "And that she might change her mind..."
    ...
    mc "Oh really, so I’m on thin ice now? Just because you’ve done nothing but shower us with empty support and want me to take responsibility for {i}your{/i} selfishness?!"
    ...
    if(end_dir == "YN"):
        ...
        s 3d "I see..."
        s "Gosh, it sounds..."
        s "Like she kind of just snapped..."
    ...
    y "...Oh. It’s you."
    mc "Is Natsuki here?"
    y "She is. But she’d rather you leave her alone."
    mc "Please, I need to speak to her."
    y "I’m going to say this once and only once..."
    y "Get off my property, and leave my daughter alone."
    y "That isn’t me saying that as someone who’s trying to control her, either."
    y "That’s me respecting my daughter’s wishes for the first time in her life."
    y "I’ve done what I could to change for her."
    y "And I’m not jeopardizing my second chance with my princess just to give you yours."
    y "Leave. Now."
    $ y_name = "Yuri"
...
#Start Scene 11b - Sayori Neutral Ending
    ...
    mc "Eheh, I do?"
    mc "Well, that is..."
    mc "Natsuki, there’s something we need to talk about."
    n 4bt "A-about what?"
    ...
    "Natsuki nudges me, and I realize it’s because I’ve been saying ‘me’ and not ‘us.’"
    ...
    n "Listen!"
    n "I said I don’t hate you! But that doesn’t mean I’m not upset with you, of course I am!"
    n "But if I’ve learned anything lately is that people deserve second chances, and I won’t get anywhere by pushing people away the second they wrong me."
    ...
    "I... really wish I’d have done something differently then. If I put the blame wholly on Sayori I’d be a real piece of crap."
    ...
    show natsuki 4bi at t11 zorder 2
    n "So..."
    show natsuki at t22 zorder 2
    ...
    mc "Then explain who so we can make it easier."
    ...
    s "That’s why... that day...{w=0.25} I chose to do something for me, for the first time ever in my miserable life."
    ...
    "...yeesh..."
    n 2bc "I felt like I was being betrayed and thrown away and disregarded again, but this time by the two most important people in my life."
    ...
    n "It’ll take some time to forgive you, but as long as you help me out here, I know I can do it."
    n 4bj "But you need to first forgive yourself."
    n 4bm "Sayori...{w=0.5} I love you so much, you’re a wonderful person and I’m proud to call you my friend."
    ...
    show sayori 1bf at f21 zorder 3
    s "..."
    s 1bh "You have each other."
    s "I think that should be enough."
    show sayori 1bg t t21 zorder 2
    ...
    mc "Sayori, please don’t say things like th-{nw}"
    show sayori 1bw at f21 zorder 3
    s "I’M NOT TAKING NO FOR AN ANSWER. LEAVE BEFORE I HURT YOU MORE."
    ...
    n "She doesn’t have to be such a self-destructive dummy all the fucking time!!"
    ...
    "I examine it more closely, and turning it around 180 degrees I see some embroiderment in the rim of the hat."
    "It reads..."
    "‘{i}Natsuki’s Man.’"
    ...
    n 2bl "It looks so silly, but... I really love it."
    n 2bj "I’m sure I’ll be laughing like a dummy every time I see it."
    ...
    mc "So am I. I love you, Nats."
    n 4bj "I love you, too, [player]."
    show natsuki at thide
    hide natsuki
...
#Start Scene 11c - Yuri Neutral Ending
    ...
    n 1bp "FUUUUUUCK-"
    n 1bo "It hurts, it hurts, it huuuurts-{nw}"
    mc "Natsuki!"
    ...
    n 12bi "I can’t fucking stand this!"
    ...
    n 12bh "Why are you taking her side?!"
    ...
    n 1bs "Then..."
    n "Sure."
    n 1bn "But...{w=0.25} How are we gonna do it?"
    ...
    m "Oh, and I think Yuri doesn’t have any intention to make peace."
    scene bg livingroom
    with fade
    ...
    y 4bb "I’m sorry...{w=0.25} for hating you."
    ...
    y 3bq "Your- Your boyfriend and yourself..."
    y 3bj "I don’t wanna see you two anymore..."
    y "Whether it’s in the street or in the literature club."
    y 1bh "It’s why I left."
    y 2bf "And since I can’t really leave school or move away, I’d prefer if we cut contact."
    y "Completely."
    show natsuki at thide
    hide natsuki
    ...
    m "I’ve got some...{w=0.25} twins I know who are joining the club."
    m "Well don’t worry about me, worry about yourself."
    ...
    menu:
        "Stay":
            mc "I'm sorry Monika."
            mc "We... {w=0.25}can't just leave so easily."
            m "I understand."
        ...
        "Leave":
            ...
            n "Its-"
            n "..."
            n 5bu "It's better if we...{w=0.5} leave..."
            show natsuki at t11 zorder 2
            "Natsuki?"
...
#Start Scene 11d - Good Ending
    ...
    n 2bd "Yeesh, buddy, there isn’t even mistletoe above us. Hehe~!"
    mc "I don’t conform to generic Christmas traditions like that. If I wanna kiss my girlfriend I’ll do it whenever and however I darn well please."
    n 1bl "I like that."
    mc "So, what is this heavenly breakfast I’m smelling? I swear it smells like-{nw}"
    n 4bc "Peppermint? Hehehe, yeah, they’re my famous Christmas Peppermint pancakes."
    mc "Son of a..."
    ...
    mc "When did we even get thos-{nw}"
    ...
    mc "Uh...{w=0.25} we do, it’s just in the basement."
    ...
    n "I’m not taking ‘no’ for an answer here."
    ...
    n 1bu "[player]...{w=0.25} this is unbelievable..."
    ...
    n 1bn "Thank you... thank you thank you thank you..."
    ...
    n 5bm "Do you think you could come with me to drop this present off?"
    n 5bn "I’m...{w=0.25} nervous to do it by myself."
    ...
    n 2bt "Y-yeah, I don’t mind."
    "I pick up the locket, and look at the front. Engraved in it appears to be the name of Natsuki’s mother, Kaiya."
    ...
    n 12bi "Thank you."
    n 2bu "I think I really am taking steps on the path to forgiveness."
    n 2bj "On the path to Kaiya..."
    show natsuki at thide
    hide natsuki
