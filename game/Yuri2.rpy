...
#Scene 1    
    ...
    "Yuri gets up, trying to cover herself with the blanket."
    mc "It’s alright, you didn’t miss anything."
    show yuri blak
    play music t5
    "She yawns lightly, looking up."
    y blaa "Is everything okay?"
    mc "Yeah, I just woke up myself."
    y "I see."
    y blab "I suppose its good to say 'good morning' then."
    y blaa "What time is it?"
    mc "Around 8 o'clock."
    y "Oh, okay."
    ...
    mc "What is it?"
    y blao "I didn’t plan to stay over."
    y "I don’t have my school uniform!"
    show yuri blao at t11 zorder 2
    "Whew, I'm in the clear."
    "But this is really bad too!"
    "What do we do?"
    "Maybe..."
    ...
    "{i}I hope.{/i}"
    "I get up, putting on a thick jacket and some fuzzy pants I had in my closet."
    ...
    "I haven't even started running yet and I can already feel some adrenaline kicking in."
    ...
    "The freezing cold winds hit me like a truck the moment I stepped outside."
    ...
    "I don’t go sprinting often."
    "Or at all..."
    "..."
    "How much further is it?"
    "I could feel my muscles already aching."
    "..."
    "..."
    scene bg road
    with wipeleft_scene
    ...
    hide natsuki
    "Ah damn."
    "As I turn a corner, I get the feeling I’ll be hearing plenty about this later."
    "But for now, I have to keep going."
    "No point in worrying."
    scene bg yuri_house
    with wipeleft_scene
    "After running a bit longer, I'm completely out of breath just as Yuri's house finally appears in front of me."
    "{i}Huff...{/i}"
    "{i}Puff...{/i}"
    ...
    with wipeleft_scene
    "As I turn onto another street, I feel the last of my energy pushing through."
    "..."
    "{i}Ha...{/i}"
    "{i}Ha...{/i}"
    "{i}Ha...{/i}"
    ...
    "Am I lost?"
    "I can’t be."
    "I went in the same direction as before."
    "Is that... my house?"
    "Please…{w=0.5} let it be my house…{w=0.5}"
    ...
    "I'm completely drained right now."
    "I really should listen to Monika when she tells me about her exercise tips."
    "Maybe then I'd be able to run five seconds without nearly passing out."
    ...
    y 3u "You must be very hungry after all that running."
    y 4e "Just for me."
    "I'm shocked."
    ...
    mc "Oh, thanks Yuri."
    "There on the table lie two sunny-side eggs, and I wolf them down quickly."
    "They were okay for the most part, but considering I don't even make myself breakfast, they're great."
    ...
    y 1v "There wasn't much to work with."
    y 2n "Not that, uh..."
    mc "Don’t worry about that."
    mc "I know that I don’t have everything I need."
    "..."
    y 1m "..."
    ...
    "I couldn't help it."
    "She's just so cute when she gets like this."
    ...
    y 2u "Oh, well...{w=0.25} that makes me happy."
    ...
    y 2a "Don't worry. I know what you mean." 
    y "You're a very caring person and just want to see your friends do well."
    ...
    "..."
    mc "How about we head to school now?"
    mc "We’re already set back as it is."
    ...
    "That sounds like a generic line from a romance movie, but it’s really true."
    ...
    "Then Sayori would try to defend me with a story from when we were kids."
    "Monika would intervene with a laugh and tease me, challenging my normality."
    ...
    "Crap."
    mc "Um, the purpose of the blue blood is to show the grieving state of the victim." 
    mc "They know that they’re dying, and they're trying to come to terms with that."
    n "Correct."
    $ n_name = "Natsuki"
    ...
    "I see Yuri giving me a bright, knowing smile."
    show yuri at thide zorder 1
    hide yuri
    "That alone gets me through the remaining classes in a good mood."
    stop music fadeout 2.0
    scene bg corridor
    with wipeleft_scene
    play music t5
...
Sincerely,
    ...
    mc "Me?"
    mc "Um, I don't know what you're talking about."
    n "Oh really?"
    n "Because I saw this unassuming, scrawny, worn out guy running across the road this morning and thought you might know something about it."
    mc "Erm, well it can't be me, because I only wear my fuzzy pants at night."
    n 1d "Hey, how did you know he was wearing fuzzy pants?"
    n "I never mentioned that."
    mc "Er, well…"
    "Crap, she totally has me cornered."
    mc "I was just, uh--"
    mc "Well, what were you doing up so early for school?"
    n 2d "I just happen to walk to school that early."
    ...
    show natsuki 2p at f22 zorder 2
    ...
    show natsuki 1u at t22 zorder 2
    n "Err... I... need to go somewhere."
    "Natsuki suddenly runs down the hall."
    show natsuki at thide zorder 1
    hide natsuki
    ...
    menu:
        ...
        "Go to Sayori’s House":
            ...
            s 3bd "You haven't been here for a very long time."
            s "I was starting to worry you forgot about me."
            ...
            s 4bm "The club was cancelled today?!"
            s "Why?!"
            "That answers my question."
            mc "Monika wrote a note saying there was a family emergency or something."
            ...
            mc "Classic Sayori."
            mc "Let me see it to make sure it doesn't get too swollen."
            ...
            s 3bh "It is too!"
            s "I saw it changing color and it looks really nasty."
            ...
            s 2bl "Anyway, what's going on with you?"
            s "Are you gonna do anything now because the club is cancelled?"
            mc "Well, I'm going with Yuri to the library."
            mc "But I should head home right now to change and clean my room."
            s 4bc "Wait, clean your room?" 
            s "Your room is dirty?"
            s "It's usually pretty clean."
            "Why do I even speak?"
            mc "Um... i-it's just dirty, okay?"
            s 1bb "Do you need help?"
            s "I can come over to your house to clean with you."
            ...
            mc "It'll be fine Sayori."
            mc "I'll just clean the rest afterwards."
            s "But what if Yuri comes over?"
            s "She won't think so well of you if your room is dirty."
            ...
            "{i}Sigh{/i}."
            "There's no way of talking her out of this."
            mc "Fine, you can clean for me."
            mc "But don't go snooping around too much."
            s 4br "Yaaaay!"
            scene bg residential_day
            with wipeleft
            ...
            mc "Okay, see ya later Sayori, and thanks again."
            s 4bs "Bye! Have fun!"
            mc "For sure."
    ...
    "I see Yuri coming down the way."
    "Aside from her usual casual get-up, it appears she's carrying a satchel."
    y "Hello, [player]."
    mc "Hi, Yuri."
    ...
    y 1bb "Yes, I come here often after the club ends."
    ...
    y 3bn "Oh, w-well... It’s just... I wanted to get you something."
    y 3bq "I-I saw a copy for purchase in their at a bookstore I was visiting, and thought it would be nice for you to... have."
    mc "Oh, I see..."
    "This is some déjà vu."
    y 2bq "Let’s just, ah... go inside."
    mc "Yeah, sure."
    scene bg bookstore
    with wipeleft_scene
    ...
    "I turn to the people around me."
    "While there were few just as Yuri said, I feel completely out of place."
    ...
    y 3bt "Is this spot okay?"
    y "This is where I usually sit."
    mc "Oh yeah, it's fine."
    y 2ba "Alright."
    ...
    y 2bp "Eh? {i}We did?{/i}"
    "Yuri really seems to be out of it."
    ...
    "I feel like I’m being tested with this."
    "I have to find a book that will impress Yuri."
    ...
    "Aside from the name, they also share the same style for their cover, but it also has a different author."
    "It’s practically got Yuri’s name written all over it."
    "The second one, \"King of Games,\" is a little more my speed."
    "It’s a manga, but the concept is really interesting, using horror to bring the tension in some teenager's regular life."
    "It’s taking all my self restraint to not jump into it right now."
    "The third one, \"Captain Bimports,\" is a blast from the past for me."
    "I remember reading these books as a kid, and I had no idea they were coming out with more."
    "I don’t think Yuri would particularly care for it, though."
    ...
    if book == 1:
        ...
        mc "Oh this? It's the \"Portrait of John.\""
        mc "I picked it up a few seconds ago to read i--"
        "She takes the book out of my grasp to further inspect it."
        n "Well, duh you're gonna read it."
        n "I mean what are you doing holding {i}this{/i} book?"
        ...
        n "Well, don't even bother."
        n "This book is {i}absolutely{/i} awful."
        ...
        mc "Hey, what's your deal?"
        mc "I just want to go and read this already."
        n "How inconsiderate of you to just take the book from my hand and try to walk off!"
        n "Let me tell you something, I've lived through a lot in my life and I'm not about to be disrespected by some high school brat!"
        n "I'll have you know that my dad is a doctor and knows a lot!"
        "I feel like I'm losing brain cells listening to this person."
        "I just want to get back to Yuri already and forget about this."
        "I avert my eyes to hopefully avoid the chatter."
        n "Hey, don't you go ignoring me, I'm talking to you!"
        n "You young people need to learn what respect is!"
        "My patience is more dried up than kelp in the desert."
        "I try walking off again, but my arm gets seized by the woman."
        n "Hey, stop walking off!"
        n "I'm just trying to get this disease away from human contact!"
        n "It would be an absolute nightmare if there was a series of this."
        ...
        "My brain feels like it's melting through my ear canals."
        "I wasn't aware this level of self-idealization was possible."
        "She's the complete opposite of Yuri, completely uncaring for the people she speaks with."
        "I just want to be back with Yuri already."
        "My wish is suddenly granted as Yuri walks around a shelf to find my predicament."
        show yuri 1ba at t11 zorder 2
        y "Hey [player], are you there?"
        y "You've been taking a while and I was wondering if you'd gotten lost."
        ...
        n "Are you really just gonna ignore me like that?"
        n "I'll just tell this girlfriend you have about how you snatched that book out of my hand!"
        ...
        n "Are you seriously telling me how uncomfortable he is right now?"
        n "Do you even know how disrespectful he has been to me?"
        n "He tried to walk away with that horrid book!"
        y "Madam, any attempt to better oneself with new information is admirable."
        y "So much can be learned from that which we don't believe we understand."
        y "If we push off what we don't accept just because it's different, we do less for ourselves overall."
        y "Are you at all aware of that?"
        n "I'm aware that you're defending this boy with your lovey dovey words."
        n "What makes you think I'll just walk away from you now?"
        "This woman won't go away no matter what we do."
        "I rack my brain for ways that Yuri and I can avoid this woman, but Yuri starts going again."
        ...
        y "Just like it did with me and the administration of this library."
        y "So if you would like to be a visitor here, I would suggest you end your foolish behavior."
        ...
        mc "No, you really helped me, Yuri."
    ...
    if book == 2:
        ...
        mc "Oh, have you read the book already?"
        "Maybe she was just turned off by the plot or something."
        n "No, but I saw this post on my social media and it looked very demonic."
        n "This is gonna teach kids how to summon demons!"
        ...
        mc "I just want to go and read this already."
        n "How inconsiderate of you to just take the book from my hand and try to walk off!"
        n "Let me tell you something, I've lived through a lot in my life and I'm not about to be disrespected by some highschool brat!"
        n "I'll have you know that my dad is a doctor and knows a lot!"
        "I feel like I'm losing brain cells listening to this person."
        "I just want to get back to Yuri already and forget about this."
        "I avert my eyes to hopefully avoid the chatter."
        ...
        n "That can't be true."
        mc "Why not?"
        n "Because I haven't seen a movie of this."
        n "If it was popular, then it would have a movie."
        "My brain feels like it's melting through my ear canals."
        "I wasn't aware this level of self-idealization was possible."
        "She's the complete opposite of Yuri, completely uncaring for the people she speaks with."
        "I just want to be back with Yuri already."
        ...
        y 3bo "But you did choose it out, so maybe it won’t be as... childish... As I thought it would be."
    ...
    if book == 3:
        ...
        "Just as I started to move, however, I felt a violent tug on my arm."
        play music t7
        n "What's that book you have?"
        n "It reminds me of something."
        mc "Oh this, it's \"Captain Bimports.\""
        mc "I picked it up a few seconds ago to read i--"
        "She takes the book out of my grasp to further inspect it."
        n "Well duh, you're gonna read it."
        n "I mean what are you doing holding {i}this{/i} book?"
        ...
        n "Well don't even bother, this book is {i}absolutely{/i} awful."
        mc "Oh, have you read the book already?"
        "I really doubt it, but her excuse for hating it can't be too dumb right?"
        ...
        n "That can't be true."
        mc "Why not?"
        n "Because those books are meant for little kids!"
        n "Any mature people should feel embarrassed to like those things!"
        "My brain feels like it's melting through my ear canals."
        "I wasn't aware this level of self-idealization was possible."
        "She's the complete opposite of Yuri, completely uncaring for the people she speaks with."
        "I just want to be back with Yuri already."
        ...
        mc "Yeah, something just told me this would be an enjoyable experience."
        y 2bq "A-Alright."
        y "I can’t really be mad if you’re making an attempt to... diversify your range."
    ...
    y s4ba "Oh, uh, it’s just that time went by so quickly when we were together..."
    y s4bb "And kind of wished it would've been for a little longer."
    "I was not expecting this, what does Yuri want to do?"
    mc "Well, we can go to my house if you’re interested."  
    y s2bj "Oh, I would love to, but I think I need to get home."
    y s2bq "There are some things I need to take care of."
    mc "Oh, alright."
...
#Scene 2
    ...
    "I text back, and she replies immediately."
    mc "Sure thing."
    y "Great, thank you."
    ...
    "Yuri doesn't usually act out to this degree, at least before."
    "I get that it's just a text, but this seems very strong coming from Yuri."
    "Perhaps I'm looking too deep into this."
    "It is just a text after all."
    "I should get some clothes on and get the day started."
    scene bg kitchen
    with wipeleft_scene
    "As I'm about to start making breakfast, I decide to ask Yuri if she wanted to do anything specific when she gets here."
    "What I thought would be a simple response took Yuri at least a few minutes to respond."
    "She eventually responds with a simple text."
    y "If it's not too much, can you set up your console?"
    y "I want to try a video game again."
    ...
    "When we did something in the past it never felt forced, but something just feels different this time."
    "Wait, what am I even saying?"
    "She just wants me to set up a console."
    "Why am I feeling so paranoid right now?"
    ...
    "My thoughts are interrupted once again with another notification."
    "Yuri's on fire today."
    y "[player], I was just wondering."
    y "If I were to do something ridiculous, would you still love me?"
    stop music fadeout 2.0
    "I read the message again to make sure my eyes aren't deceiving me." 
    "What does she mean by that?"
    "I quickly respond back to her."
    mc "Of course I'll still love you."
    mc "You're the greatest thing that has ever happened to me."
    ...
    "Is she experimenting with anything?"
    "Maybe she's read a book about something and is trying new things."
    ...
    "But the thoughts chase after me as I move through the house."
    ...
    "But there is one thing I know, and it's that I love her."
    "She's entirely worth it."
    ...
    mc "Yuri!"
    y 1bc "Hi, [player]."
    y "I'm so happy I could come over today."
    y 2bq "Truth be told, I've been a bit worried over a few things."
    mc "Really?"
    mc "Is there anything I should be concerned about?"
    y 2bg "No, nothing major or to be afraid of."
    ...
    y 1bf "[player], are you okay?"
    mc "Oh, sorry, yeah."
    mc "Got a little stuck in my thoughts for a bit."
    mc "Here, come inside."
    show yuri 1ba at t11 zorder 2
    "Yuri walks into the house and onto the couch, setting her satchel down beside her."
    ...
    "Really, [player]?"
    "It's been at least 6 months and that's all you can say?"
    y 2bg "I suppose it's nice."
    y "I haven't been really paying attention outside much."
    y "To be perfectly honest, I've just been at home thinking."
    mc "Really, thinking about what?"
    y 3bq "Well, it's just... last week I really put myself out there, so I suppose now I'm just trying to figure out how to move on."
    y 3bj "It's weird."
    y "I didn't think that I'd get this far."
    y "So when I did, I guess it only makes sense that I would become my own worst enemy."
    mc "What do you mean?"
    y 2bq "Oh, it's nothing."
    y "I've probably been rambling about too much anyway."
    y 1bs "How about we start playing that game now?"
    mc "Sure thing."
    ...
    if game == "correct_game":
        ...
        mc "Oh okay then, I'll see what I can find."
        ...
        "Hmm, I wonder what other game we could play..."
        "Just in the corner of my eye, I see another game."
        "{i}The Flaming Symbol: Four Seasons{/i}."
    ...
    if game == "other_game":
        stop music fadeout 2.0
        y 2bt "Um, [player], can we play a different game today?"
        y 2bq "One that's maybe more story driven than the last one..."
        y "Those exist, right?"
        mc "Of course they do!"
        mc "In fact, I think I know a game you would enjoy."
        ...
        "Then like magic, on my desk, I see another game."
        "{i}The Flaming Symbol: Four Seasons{/i}."
    ...
    "I go downstairs to see Yuri fidget with her arms."
    "When she sees me she moves her arms very close to her."
    mc "Hey Yuri, everything okay?"
    y 3bp "Ahh, no! I-I just had an itch to scratch..."
    mc "Oh, okay then."
    mc "I'll just get the console set up now."
    ...
    y 2bg "It's bringing up that castle a lot, and that woman."
    ...
    y 2bf "[player], why did you do that?"
    y "Didn't you have a lot of progress?"
    mc "Ah, not really." 
    mc "Besides, I don't mind restarting."
    y 3bs "You're so kind, [player]."
    mc "Well, you're not any different."
    mc "You reread Portrait of Markov just to read it with me."
    ...
    y 2bg "That woman again..."
    y "I'm curious with her importance to the story."
    ...
    mc "The woman?"
    mc "The guy just got his head sliced off."
    mc "I don't think it can hurt more than that."
    ...
    y "None of them seem particularly trustworthy, but perhaps I'm thinking that because I just don't know them enough."
    mc "What do you mean?"
    ...
    y 2bh "The key features with this art style is in the face."
    y "But I can't see their intentions clearly, which I know was done on purpose by how they contrast with the other characters introduced so far."
    ...
    y 2bq "Are you sure?"
    y "I was just thinking out loud really."
    ...
    y 1bs "Well then, I'm glad I was able to help."
    ...
    y "I thought games were shorter than this."
    mc "RPGs tend to have much longer play hours compared to other games, so it's only natural."
    mc "You really made it speed up though."
    mc "You were so talented going through it."
    y s2bq "Thank you, but I don't really think I deserve the attention."
    y "I was just having fun."
    mc "But you do deserve it."
    mc "You looked really happy while playing."
    show yuri s2bv at t11 zorder 2
    "Yuri has no comment on this."
    "I don't think she's allowing herself to realize what she can do."
    stop music fadeout 2.0
    "I then notice Yuri's arms start to move, both rubbing against each other."
    y s4bb "I don't know what you mean."
    y "I'm just..."
    y "No that's not it, I know you don't see me like that."
    mc "See you like what?"
    "Yuri's movement becomes more erratic."
    "Her breathing becomes heavier as well."
    play music t9
    y s4bc "Well, like a freak."
    y "You love me despite my apparent flaws."
    y s4bb "I'm just the girl who reads horror books for fun, the weirdo that always needs to excuse herself."
    y "I feel so awkward with myself so often, yet you're so patient with me."
    "Yuri's arms shift quickly across herself, like there's a puppet master controlling her for amusement."
    y "The part that scares me the most is that this isn't even the first time we've had a conversation like this." 
    y "Will there be more?"
    y "Will I be able to accept myself like you have?"
    y "Or will you move on to a girl that's more sane, less, less--"
    mc "Yuri!"
    show yuri s3bp at t11 zorder 2
    "To stop her thought, I grabbed her arm, but then I remembered her cuts."
    y "Ahhh!"
    mc "Oh my God, Yuri, I'm so sorry!"
    y s3bo "I-It's alright, [player]."
    y "I was...{w=0.5} losing myself there."
    "A couple of moments pass while Yuri recovers from the pain."
    stop music fadeout 2.0
    "My doubts came back to me while waiting."
    "But I guess now's as good a time as any to get them out."
    mc "Yuri, I'm sorry to ask this, because I know that its personal."
    mc "But... I need to see your arms."
    show yuri s2bw at t11 zorder 2
    "It takes her a moment to think, but she complies, nodding her head."
    scene bg black
    with dissolve_scene_full
    "Slowly, she rolls up her sleeves, revealing her arms to me."
    scene bg livingroom_sunset
    with wipeleft_scene
    play music t10
    show yuri s4bwc1 at t11 zorder 2
    "The scars seem to be healing, but it's still very much visible."
    y s4bhc1 "I'm sorry for being such disappointment."
    mc "What?"
    y s4bvc1 "Even after showing these to you the first time, I... still remember getting a ride off of the pain."
    y "I'm still the freak who likes to cut herself."
    y "I still feel as if I need to live off the pain."
    y s4btc1 "[player], I'm just so confused right now."
    y s4boc1 "Because even with you around me, I still can't avoid the rush that it gives me."
    y "You make me more alive than anything else, but when I'm not with you, what am I?"
    y s4btc1 "These thoughts, they've been entering my head since last week."
    y "I've been going out with you more often to see if I can replace it, but for some reason I can't."
    y "I still depend on it, the pain."
    y s4bwc1 "{i}huff{/i} Isn't that poetry?"
    y "I have the answer right in front of me, yet I still hit a wall..."
    y s4btc1 "[player], even though it's wrong, I still have to."
    "To think she kept it all in like this, it hurt to hear."
    "But I had to know something."
    mc "Yuri, have you cut yourself since we last talked like this?"
    y s4bvc1 "No... but I'm not sure I can last any longer."
    mc "Well, you said you want to replace it."
    mc "What can I do to help?"
    "Yuri pushes her head against my chest."
    scene bg black
    with dissolve_scene_full
    y "I-I... want to feel your heat, let it radiate on to me."
    y "I want to feel your heartbeat."
    y "I want to know it beats for me."
    ...
    "What will she do?"
    "I can't be her only support."
    "There's a chance she might hurt herself if I'm not there."
    "Well, whatever it is, I can figure it out later."
    "Right now, I need to keep myself with her, and try to comfort her now."
    "..."
    "..."
    "..."
    mc "H-Hey Yuri."
    ...
    with wipeleft_scene
    show yuri n1bm at t11 zorder 2
    ...
    y n2bs "Yes, just a bit."
    mc "Is there anything I can do to help?"
    y "Well, do you know what that tea you made us was?"
    mc "Uh, I think it was Ginseng tea, right?"
...
#Scene 3
    ...
    y 1b "I'm glad you find yourself agreeing with my assessments." 
    y "Really, he's a great character."
    y "I just find a lot of people seem to not give him a chance."
    ...
    show monika 1b at f43 zorder 3
    ...
    "Yuri sighs."
    show monika 1a at f43 zorder 3
    ...
    s 1l "Wait, They did?"
    s "Well, they did say something about us wasting too much time..." 
    ...
    m 2b "So, I was thinking... how about we all go out somewhere tomorrow?"
    ...
    show monika at t43 zorder 2
    show natsuki 1h at f41 zorder 3
    ...
    show monika at t43 zorder 2
    show yuri at f44 zorder 3
    y "I'm sorry, but I must agree with Natsuki."
    y "This seems a little inappropriate!"
    "Naturally, something like this is a worry to Yuri."
    "It's taking her out of her comfort zone by a long shot."
    ...
    show sayori 4r at f42 zorder 3
    s "Aww c'mon [player], you love bowling!"
    show sayori 3c at t42 zorder 2
    mc "Eh? Me?" 
    mc "Where are you pulling that one from?"
    show sayori 3q at f42 zorder 3
    s "Yeah! You don't remember?"
    s "My 10th birthday, silly!"
    ...
    s 5b "Aw, don't be so dramatic!"
    s "Other than the nosebleed, you had a grin on your face!"
    ...
    show monika at f43 zorder 3
    m 5a "Daunting?"
    m "Come on Yuri, you've breezed through final exams more stressful than a game of bowling."
    show monika 1a at t43 zorder 2
    show sayori at f42 zorder 3
    s 4h "I dunno, Monika."
    s "Some people just aren't comfortable with competitive games like that."
    ...
    show monika at t43 zorder 2
    show yuri at f44 zorder 3
    y 2r "Monika! That is the most ridiculous--{nw}"
    ...
    hide sayori
    show natsuki 5u at t21 zorder 2
    show yuri 2o at t22 zorder 2
    ...
    "Natsuki leaves, clearly frustrated."
    "Wouldn't have pinned her down for that, but I guess you learn something new every day."
    "Yuri sits at her desk dumbfounded, still processing the information."
    ...
    with wipeleft_scene
    play music t12
    show yuri s1l at t11 zorder 2
    "We're about halfway home and she still hasn't spoken a word."
    "I decide to break the silence."
    mc "Hey Yuri, is-{nw}"
    stop music fadeout 2.0
    play music t7
    y s1r "I can't believe her!"
    "Man, have I managed to get a single complete sentence out today?"
    y "It's a literature club and she's taking us {i}bowling{/i}?"
    y "I still can't believe it."
    y s2r "I'm being perfectly literal, by the way."
    y s1h "I refuse to believe I understood any of this properly."
    mc "Aha..."
    mc "Yeah, I get you."
    mc "It's not that I mind bowling, but it's bizarre."
    mc "It's like it literally came out of nowhere."
    y s3r "Isn't it?!"
    y s1q "I... I just keep thinking about the whole idea of it..."
    y s2t "I don't think I'll be able to--{nw}"
    y "No... {w=0.25}I {i}know{/i} I won't be able to be in a place like that."
    mc "W-What?" 
    y s1v "You know I don't handle public places very well."
    mc "...You got along fantastically in the library, though."
    y s1h "Well, yes, but not all of them operate the same way."
    y s1f "In the case of that library, it's a place meant for reading."
    y "Nobody bothers you."
    y "Places like that, or like a park, those are fine."
    y "It's quiet, and interaction is low."
    mc "What about that lady?"
    mc "Y'know, {i}her{/i}."
    y s1l "She was... a rare and unfortunate exception."
    y s1f "As often as I go there, I'm obviously not familiar with all its regulars." 
    ...
    stop music fadeout 2.0
    y s1h "Regardless... this whole bowling thing..."
    play music t12
    mc "Right, right. That's what we were talking about."
    y s1f "It's not just that it's a public place, or that it has nothing to do with the theme or purpose of the club."
    y s1q "It's also to do with the fact that it's a physical activity requiring active engagement in said activity."
    y "That just feels very... wrong to me."
    y s1h "It's not my thing."
    y s1f "Worse still, it's a popular place."
    y s1o "Crowds, physical activities, no reading, no quiet..."
    y s3n "It's sending my anxiety through the roof."
    mc "Hey, come on."
    ...
    mc "But I'm sure it'll be fine."
    mc "The others will be there, and I'm sure we can have some fun with the others."
    y s1u "R-Right..."
    "Saying that to someone taller than you, even if by only a few inches, is a bit awkward."
    "I can't imagine it's any less so on her end."
    "Either way, all of this is certainly new information to me."
    "I mean, I should realize by now that Yuri's shy."
    ...
    s "I still don't get it, Yuri."
    s "Why come all this way?!"
    ...
    s "I... I live next door."
    s "You didn't know that?"
    show sayori at t21 zorder 2
    show yuri 1bo at f22 zorder 3
    ...
    mc "Okay, I should probably get ready if we're all going to go."
    mc "You both can wait for me outside, alright?"
    show sayori at thide zorder 1
    hide sayori
    show yuri at thide zorder 1
    hide yuri
    "I herded the both of them out of my room, and began to get prepped for the today."
    stop music fadeout 2.0
    scene bg bowling_alley
    with wipeleft_scene
    show natsuki 1ba at t41 zorder 2
    ...
    mc "I guess that explains why you're so happy."
    mc "You never sigh."
    mc "Despite your name, I guess."
    show sayori at f42 zorder 2
    s 1br "Ehehe..."
    s 1bo "I don't get it."
    show sayori at t42 zorder 2
    ...
    show natsuki at thide zorder 1
    hide natsuki
    "I get close to her in an attempt to give some sort of comfort, as Monika calls our attention."
    show monika 1bb at t11 zorder 2
    show yuri at thide zorder 1
    hide yuri
    m "Alright, everyone! We need to get our bowling shoes."
    m "I need to know everyone's shoe size."
    show natsuki 1bc at f22 zorder 3
    show monika 1bb at t21 zorder 2
    n "Can't we just buy our own shoes?"
    n "You're not our mom."
    show natsuki at t22 zorder 2
    show monika 3bl at f21 zorder 3
    ...
    show natsuki at f22 zorder 3
    show monika at t21 zorder 2
    n "Really putting the literature in literature club."
    n "With... bowling."
    show natsuki at t22 zorder 2
    show monika 1bh at f21 zorder 3
    ...
    m "You too, Sayori?"
    m 1bi "Look, come on, we're all here."
    m "Whether it was a bad decision or not, we might as well make the most of it, right?"
    ...
    "Not that the shoes are the right size, since we didn't actually give them to Monika."
    "Honestly, I'd complain, but I know it'd just make her feel worse."
    ...
    "Absent-mindedly, I grab her hand."
    ...
    show sayori 1bc at t44 zorder 2
    m "Okay, everyone!"
    m "How many of you know how to play?"
    ...
    mc "Ah, more or less."
    show monika 1bb at f42 zorder 3
    m "Wow, that's surprising! I'm impressed."
    show monika 1bb at t42 zorder 2
    "Is she insulting me?"
    show yuri at thide zorder 1
    hide yuri
    ...
    show yuri 2bo at t11 zorder 2
    "It's Yuri's turn."
    "She again seems all too nervous."
    ...
    "Her frame being over, she sits down, taking the empty seat next to me."
    "Sayori goes up next, and ends up bowling two gutter balls in a row."
    ...
    m 4bn "Man, I expected better from her."
    m "It's like she was waiting exactly for you to be distracted so she could leave."
    "What...?"
    ...
    mc "She's sure uh, taking a minute, huh?"
    mc "I guess we can skip her again..."
    show monika 3bl at t11 zorder 2
    m "Yeah, it's a shame."
    m "She might've even just left by now."
    ...
    show monika at thide zorder 1
    hide monika
    "Last time I was just overreacting because she took a while..."
    "But how come she wasn't at the counter?"
    ...
    n 3bb "I think you should go look for her."
    n "I can take over your bowls if you want, or we can just skip you like we have been for her."
    n 3bq "I knew she'd be against this."
    n "I don't like it much either."
    n "But I didn't expect her to take it like this..."
    ...
    show yuri 4bb at t11 zorder 2
    "I head over to where the clerk mentioned, and find Yuri sitting alone at a table overlooking an empty lane nearby."
    ...
    show yuri 4ba at t11 zorder 2
    mc "And besides, we're your friends."
    mc "Why would we think less of you for something like this?"
    show yuri 4bb at t11 zorder 2
    "She looks away from me for a bit, thinking."
    "A determined look finally forms on her face."
    y 2bu "You're... you're right."
    y "Let's get back there, [player]."
    ...
    show monika 1bl at t41 zorder 2
    ...
    "It's weird..."
    "It's as if that one play threw Monika off her game completely, and she started doing worse than Sayori."
...
#Scene 4
    ...
    "Date..."
    "..."
    "I suddenly get a shaking feeling."
    ...
    show yuri s2bq at t11 zorder 2
    mc "But I think I'm mostly just saying that because of how well you did."
    mc "I still can't believe you beat Monika."
    y s2bq "Yeah, I can't believe that either."
    y "Something just clicked within me after you talked to me."
    y s2bv "But that does make me wish for something."
    mc "Wish for what?"
    y s3bw "Well, for today to just have been for the two of us."
    y s3bu "After what happened in the library and today too, I've been interested in other places we could go."
    ...
    y s2bb "That sounds great."
    y "There's this one place I've always wanted to go with a..."
    y s2bq "Well, with a boyfriend."
    mc "If you already have a place in mind, then I would be happy to go."
    y s3bd "Perfect, I'll make the reservations tonight then."
    y "Does 6 o'clock tomorrow sound good?"
    mc "Yeah sure, we can do that."
    y s2bc "Great!"
    y s2bu "Oh look at me, I didn't think I would be so excited over this."
    y s1bc "Good bye [player], I'll see you later."
    mc "Bye, Yuri."
    stop music fadeout 2.0
    scene bg bedroom
    with dissolve_scene_full
    ...
    "Not to say the library we went to wasn't one, or the times we hung out at my house, I suppose."
    ...
    mc "Oh no, it's okay."
    y 2bq "Sorry, that tends to happen."
    mc "Don't worry about it, Yuri." 
    mc "You looked really happy, and I didn't feel like interrupting."
    y 1bs "I see. Thank you, [player]."
    y 1ba "This place holds a couple of good memories for me, I suppose."
    y "Along with the food, of course."
    mc "Oh, I see."
    mc "This seems to be a bit of a go-to place for you, I'm guessing."
    y 1bb "Yes, I guess it kind of is like that."
    y "My parents took me here for many celebrations since I was little."
    y "Birthdays, good grades, graduations..."
    y 1bc "I'm really glad I was able to come and show this place to you."
    mc "Hm, it is pretty fitting."
    mc "I suppose the two of us coming here on a date is a celebration in and of itself."
    y 1ba "Hm, I agree."
    y 1bu "I... don't think I would have ever thought of coming here for something like that before."
    y 1bs "But, whenever I'm around you, I feel comfortable and happier."
    ...
    with wipeleft_scene
    show yuri 1ba
    "After a few minutes, the waitress came by again to take our orders."
    $ n_name = "Waitress"
    n "One beef java curry, and one red wine steak platter with potatoes, medium rare."
    n "Sounds great! We'll have that out for you in a jiffy!"
    $ y_name = "Yuri and I"
    y "Thank you very much."
    $ y_name = "Yuri"
    mc "Hmm, java curry... Like coffee, right?"
    mc "Can't say I have tried that before, interesting."
    y 1bb "I've heard of some recipes adding instant coffee to the mix, and coincidentally saw that they were adding it to the menu here." 
    ...
    mc "Oh, cookbooks?"
    y 2bb "Yes. Besides novels, I try to read a certain variety of books that can relate to my everyday life."
    ...
    y  1ba "Oh yes."
    y "The curry seems to have a rather richer flavor with the addition of the coffee."
    ...
    "I feel a smile crack on our faces as the both of us laugh it off."
    ...
    y n1bc "I really enjoyed tonight, [player]."
    y "It was really fun coming out with you."
    mc "Definitely, it was a lot of fun."
    mc "We should definitely do this again sometime."
    ...
    mc "I have to say though Yuri, your house is really nice."
    mc "How long have you lived here?"
    y "For a while, even before I was born."
    y "My parents moved here when they were young."
    ...
    mc "Oh, I see, I like it."
    mc "It's very cozy."
    y 1bc "I'm sure they'll be glad to hear you say that."
    ...
    menu:
        ...
        "Go check up on her":
            ...
            y 5bcc2 "But whenever we were together, playing games, reading, in bed..."
            ...
            y 3bvc2 "That's why I wanted you to be here. I couldn't let go."
            y "I couldn't bear losing you, I wanted that thought gone."
            y "To hold you and never let go..."
            y "I..."
            scene black
            with wipeleft_scene
            ...
            y "I... I know I asked earlier..."
            y "But can you please stay with me tonight?"
            mc "Of course."
        ...
        "Stay and wait for her":
            ...
            y 3bj "Just thinking about some things, that's all..."
            ...
            y "It calms me down whenever I can be near you."
            y "The world just... stops."
            ...
            y "But... I feel a lot better now with you."
            y "I don't need to worry anymore that you are here now."
            scene black
            with dissolve_scene_full
...
#Scene 5
    ...
    m "Unfortunately, you're both wrong."
    m "I've gotten us a weekend getaway at a mountain lodge!"
    show yuri 1p at t42 zorder 2
    show natsuki 1p at t41 zorder 2
    show sayori 1n at t44 zorder 2
    show monika 4b at t43 zorder 2
    "We all had a look of surprise on our faces."
    show yuri 1p at f42 zorder 3
    ...
    n 2l "Yeah, that sounds kinda neat, actually!"
    show natsuki at t41 zorder 2
    y 3g "..."
    show monika at f43 zorder 3
    ...
    y 3t "Y-Yeah. I-It does sound... a little interesting."
    y "Thank you, Monika."
    show yuri at t42 zorder 2
    mc "Hmmm, its a little out there, but it sounds nice. Thanks, Monika."
    show monika 4j at t43 zorder 2
    "With all of us agreeing in the end, it looks like our weekend is set."
    show monika 4j at f43 zorder 3
    m "We'll all meet up in front of the bus station and go from there."
    m "We can meet up there Saturday morning at, say, nine o'clock?"
    ...
    y 2q "R-Read instead?"
    mc "...Yeah."
    y 3u "It's the same with me..."
    y "I haven't really been to many hotels, but now spending a weekend in the mountains..."
    y "It's a bit ehh..."
    mc "Same here. But it doesn't sound all bad, I think."
    mc "A mountain resort, nature all around us..."
    ...
    y "Hey [player], what time did Monika say she wants us to meet again?"
    y "I forgot to write it down."
    "I look back at my calendar and remember, then reply back."
    mc "Oh, she said to meet at the bus station at nine o'clock."
    y "Thank you!"
    ...
    "As I was lost in thought, I feel a tap on my shoulder."
    show yuri 1bf at t11 zorder 2
    y "Hey, [player]?"
    mc "Yeah?"
    y "D-Did you want to keep reading?"
    mc "O-Oh yeah, sorry."
    show yuri at thide zorder 1
    hide yuri
    ...
    m "Well... nothing too strict."
    m "Just be respectful, don't make a racket or a mess..."
    m 4bk "And have fun, I guess."
    m "Ahaha~."
    show monika at thide zorder 1
    show natsuki at thide zorder 1
    hide monika
    ...
    "I hear Yuri take a deep breath."
    y "I-It's almost time..."
    y 3bv "I-I'm still a little uneasy..."
    mc "I know what you mean, but I'm sure everything will be okay."
    y 2bt "H-How can y-you be so sure?"
    "I put a hand on her arm."
    mc "It'll be fine, we're all here together."
    mc "It'll be okay."
    show yuri 2bw
    "She sighed."
    y "I-I... I suppose..."
    ...
    show yuri 1bf at t44 zorder 2
    n "THIS is the place?"
    n "Ugh, it's just old people everywhere!"
    show natsuki at t41 zorder 2
    show sayori 2br at f42 zorder 3
    s "Ehehe, it's not that bad. Everyone looks so nice!"
    show sayori at t42 zorder 2
    show monika 2bk at f43 zorder 3
    m "Well, I'm glad you like it, Sayori."
    m 1bj "Alright! Here's our plan: For today, we can all just rest and take it easy!"
    show natsuki at f41 zorder 3
    n 3bz "Sweet!"
    show natsuki at t41 zorder 2
    show yuri 1bw at f44 zorder 3
    y "Thank goodness..."
    show yuri at t44 zorder 2
    show monika 3bl at f43 zorder 3
    ...
    show natsuki 1ba at t44 zorder 2
    s "Hey... why are there only two beds?"
    show sayori at t41 zorder 2
    show monika 3ba at f42 zorder 3
    m "Actually, it's customary for hotels to only have two full-sized beds."
    m "But I think the sofa unfolds into a bed."
    show monika at t42 zorder 2
    mc "Say no more, I'll take the couch bed."
    show yuri 3bo at f43 zorder 3
    stop music fadeout 1.0
    y "A-Actually... u-umm..."
    show yuri at t43 zorder 2
    show natsuki 1bb at f44 zorder 3
    n "Huh? What's up Yuri?"
    show natsuki at t44 zorder 2
    show yuri at f43 zorder 3
    y 4bc "I-I... I-I-I a-actually have a hard t-time sleeping in a bed..."
    y "A-As in not MY bed..."
    ...
    m "We're still technically on a school trip."
    show monika at t42 zorder 2
    show yuri at f43 zorder 3
    ...
    y 1ba "Ahh, hello [player]."
    mc "Have a good rest?"
    y 1bb "Yes. It was quite pleasant."
    y "I didn't realize how sleepy I had been until I had laid down."
    mc "Yeah, seems it took a lot out of you."
    mc "Time really flew while we were out, heh."
    "I point to the clock."
    y 2bn "Oh! Oh no, were you with me the whole time?"
    y 2bo "I-I hope I didn't keep you while you were waiting..."
    mc "No, it's fine. I was a little tired myself."
    y 2bk "O-Oh I see."
    y 1bf "Where did the others go off to?"
    mc "Oh, they left to go explore the hotel a little while ago."
    y 1ba "Oh, I see. So, it's just the two of us then."
    mc "Yeah."
    mc "If you want, want to go looking around ourselves, maybe grab a snack?"
    y 2bb "Sure, we can do that."
    y 3bq "P-Perhaps we can even find a nice place to read."
    mc "Sure, sounds good."
    show yuri at thide zorder 1
    hide yuri
    ...
    y 1bc "The music, the decorations... It just feels nice being here."
    mc "Definitely. I'm curious that a place like this is in this hotel."
    ...
    mc "You looked... Wow. I didn't know you knew how to dance like that, Yuri."
    y 1bq "My parents were a little artistically inclined, and used to dance to music like this in the house sometimes."
    y "I was always fascinated, and they taught me a little bit."
    y "I would sometimes research it in other books too when I got the chance."
    y 1bm "The music reminded me a little bit of it, and I suppose it brought it out of me."
    mc "I see. That sounds very fun."
    mc "You move very well, like you were gliding across the floor."
    y 1bq "Thank you."
    ...
    show yuri 2bs at t11 zorder 2
    "I approached Yuri, holding her hand in mine."
    ...
    y 2bs "You don't know how to dance, do you?"
    mc "..."
    ...
    "Huh?"
    $ m_name = "Monika"
    show monika 4bk at f22 zorder 3
    show yuri 2bp at t21 zorder 2
    play music t6
    ...
    show natsuki 4bz at f44 zorder 3
    n "Wow, this room is nice!"
    show natsuki at t44 zorder 2
    show yuri at f41 zorder 3
    y 3bo "Sayori and Natsuki are here too?"
    show yuri at t41 zorder 2
    mc "Yeah. Yuri and I, we were ah, hanging out here, just the two of us, and..."
    show monika 2bb at f42 zorder 3
    m 3bg "[player], that almost sounds like you want us gone, but that can't be right."
    m "We're here for a school trip!"
    ...
    show monika at t42 zorder 2
    show sayori 4bl f43 zorder 3
    s "Well, I've seen it in movies and stuff..."
    s 2br "But I just got so excited, I forgot I've never done it before! Ehehe~!"
    show sayori at t43 zorder 2
    show natsuki at f44 zorder 3
    n 4br "H-How could you forget something like that!?"
    show natsuki at t44 zorder 2
    show monika at f42 zorder 3
    m 3bb "Say Yuri, weren't you just showing [player] how to dance?"
    m "Maybe you could help Sayori!"
    show monika 3bb at t42 zorder 2
    show yuri at f41 zorder 3
    y 3bp "U-Um, but...!"
    "I know what she's about to say: {i}What about helping [player]?{/i}"
    show yuri at t41 zorder 2
    show sayori at f43 zorder 3
    s 4bl "I-It's okay, Monika! I can dance with Natsuki!"
    show sayori at t43 zorder 2
    ...
    hide yuri
    hide sayori
    "For the most part, things seemed alright."
    "But even though I didn't want to think it, I could sense a darker intention to Monika's burst of sudden kindness..."
    show monika 1bj at t11 zorder 2
    stop music fadeout 2.0
    m "I really enjoy dancing with you, [player]..."
    m "It's almost like we're on a date~..."
    "Oh no..."
    mc "...Y-Yeah. Funny that."
    "I nervously chuckle, but she just puts on her trademarked Monika smile."
    play music t10
    show monika 1be at t11 zorder 2
    "Suddenly, I feel a finger rest under my chin, pulling my gaze back to her."
    ...
    show monika 1bn at t11 zorder 2
    "Monika had a look of nervousness herself swim across her face, before trying to pull herself together."
    ...
    show yuri at lhide zorder 1
    hide yuri
    "Upon seeing us, Yuri ran out of the room."
    show natsuki 1bn at t21 zorder 2
    show sayori 2bg at t22 zorder 2
    "I look at Sayori and Natsuki, seeing a worried look on their faces."
    ...
    y "T-Thank you, [player]... I-I'm sorry..."
    mc "It's okay, Yuri... I'm here now."
    ...
    mc "She's still in the room asleep right now."
    n 1bq "That's good..."
    show natsuki at thide zorder 1
    hide natsuki
    stop music fadeout 2.0
    ...
    mc "...Really?"
    m 1bg "Of course."
    m 1bf "I value both you and Yuri as my friends, and didn't want to hurt either of you."
    m 1bo "Though, knowing what I wanted to say, I should have known it would..."
    m "To be honest, I was jealous, seeing you with Yuri, all this time..."
    m "I tried not to think much of it, and I kept myself in check."
    m 1bf "But I let my emotions get the better of me the other day."
    m "And then, well... it lead to all that."
    m 1bl "Now I can see that my ah, \"plan\"... Didn't go so well."
    m "It was stupid of me to do such a thing, and I regret all of it."
    m 1br "But, there's no way to change the past."
    m 1bi "I dug this grave with my own hubris, and now I have to lay in it."
    mc "..."
    mc "Heheh..."
    m 1bd "Hm?"
    mc "S-Sorry, it's just... what you said was somewhat poetic."
    ...
    mc "I appreciate the apology, Monika."
    mc "And as wild as it was, I forgive you."
    mc "It's been a crazy time with everything, and for everyone."
    mc "You, Yuri, Natsuki, Sayori."
    mc "But even so, I still see us as friends."
    m 1bd "I..."
    m 1be "Thank you, [player]."
    mc "But I'm not the only one you should be apologizing to."
    m 1bi "I know."
    m "I'm going to go up in a little bit."
    m "Give her some time, and mentally prepare myself as well."
    m "I don't think she'd want to see me yet."
    m "But I have to explain myself, or at the very least, apologize to her."
    mc "Thank you."
    show monika at thide zorder 1
    hide monika
    ...
    n 1bu "After she found out about what Monika was planning, she got really down."
    n "It seemed to have really hit her hard."
    n 2bh "I asked if she wanted to have breakfast with us earlier, but she said she wasn't hungry."
    ...
    s 1bg "And then when Monika went and did all that..."
    s 1bf "My body just stopped, and it all just... came tumbling down."
    ...
    mc "Sayori..."
    s 1bd "But, after discussing it with Yuri just now, to put it all out there, it made me feel a lot better."
    ...
    m 1bg "I... I wanted to come up and apologize to you, Yuri, for what I did yesterday."
    ...
    m "Whether that was directly, or getting caught in the crossfire of it all."
    show monika 1bf at t33 zorder 2
    ...
    show monika 1bj at t33 zorder 2
    show sayori 1br at f32 zorder 3
    s "So long as we're all together as friends like this, we'll get through it!"
    show sayori at t32 zorder 2
    show yuri 1bc at t42 zorder 2
    show monika 1bj at t43 zorder 2
    ...
    "As we hugged, Natsuki appeared in the room, holding a plate of different foods from the breakfast table."
    n "Hey you four!"
    n "Breakfast time was going to end soon, but I managed to get us some food if you were--"
    n 1bh "...Uh, is everything okay in here?"
    ...
    show sayori 1ba at t42 zorder 2
    show yuri 1ba at t41 zorder 2
    m "Well, we still have a full day of activities ahead of ourselves."
    m "Let's get to it, shall we?"
    $ y_name = "Nat and Say"
    show natsuki 2bz at f43 zorder 3
    show sayori 3br at f42 zorder 3
    show yuri 1bc at t41 zorder 2
    show monika 1bj at t44 zorder 2
    y "Yeah!"
...
#Scene 6
    ...
    with wipeleft_scene
    play music t12
    "As I got ready for school, I take a big sigh looking out the window."
    ...
    mc "Ready for what?"
    s 4r "The last week of school!"
    mc "Oh, yeah. I'm pumped."
    s 2c "You don't sound very pumped. Is there anything wrong?"
    mc "What? No, nothing really."
    mc "It's just that I don't want the teachers to throw an assignment at us out of nowhere."
    mc "The fact that this is the last week is what's gonna let me survive."
    s 3s "C'mon, it won't be that bad."
    s "I mean, the club will still be available after."
    ...
    y "The author spends the whole story on its corrupt world and the consequences of such."
    y "We meet characters that we treasure as the reader that are taken away in this unjust world."
    ...
    "The class would be pretty bummed to read a somewhat longer story, but the story is so well-written."
    "..."
    ...
    mc "Well uh... it's a story that follows this teenage girl that has a long lost sister who moves in with her."
    ...
    show yuri 1a at t11 zorder 2
    y "Hello, [player]."
    mc "Hey, Yuri. How has your day been going?"
    y 1b "It's been going well."
    y "I find this last week to be calming for everyone here."
    mc "Good to hear."
    mc "Are you ready for the club today?"
    y 2c "Of course."
    scene bg club_day
    with wipeleft_scene
    ...
    s "What are we gonna do Monika?"
    s "I can't think of a way to keep it up."
    m "Calm down, Sayori."
    m "We don't want the others to panic over it."
    ...
    "Did anything serious go wrong before we got here?"
    show yuri 2t at t11 zorder 2
    y "Hey [player], is anything bothering you?"
    y "You seem to be puzzled."
    mc "What? Oh, it's nothing."
    mc "The room just feels more intense than usual."
    y 2w "I can understand. There does seem to be a tension lurking about."
    y 2s "How about we just sit down and read a book?"
    ...
    y 2n "You were spacing out, and didn't respond."
    ...
    mc "Everyone else has been acting strangely."
    mc "Myself included, I guess."
    ...
    "The others start getting their spirits up."
    ...
    s "Yay!"
    show sayori at t41 zorder 2
    show natsuki 5y at f42 zorder 3
    ...
    m "Well, I was going to ask you to Natsuki, but since you brought it up like that, I guess I can ask someone else--"
    ...
    y s1h "Everything's fine."
    y "Things are going as expected..."
    mc "Expected? What do you mean?"
    y s1h "Just with the club. I suppose it all comes to an end..."
    mc "Yeah, I suppose so."
    y "But um, I should probably get going inside."
    y "There's some things I have to take care of."
    ...
    s "{i}Huff{/i} {i}Huff{/i} Hey [player]."
    ...
    s 2r "I know, but it just seems so fun."
    ...
    mc "Okay then, what songs have you put on the playlist anyway?"
    s 1q "The answer is a secret until Friday."
    mc "Is one of the songs the chicken dance?"
    s 5b "Da-a, nooo...?"
    s "Well, a bit of the song is the chicken dance."
    s 4r "But can you really blame me for putting that on there?"
    s "It's so catchy!"
    ...
    s 1a "I guess I'll just have to be extra chicken with my moves at the party."
    s 1x "I'll see you later, [player]."
    mc "See ya, Sayori."
    stop music fadeout 2.0
    scene bg class_day
    with wipeleft_scene
    ...
    y 3q "Ah, y-yes."
    y "I'm just feeling a bit... distracted today."
    y 2f "Why do you ask?"
    ...
    m "I'm sorry, [player]."
    m "I was meaning to tell you what was happening, but I thought it would be funnier to throw you in a loop."
    m "I'll be sure to tell you anything else that happens."
    show monika 2k at t31 zorder 2
    mc "You say you're sorry but you're still laughing..."
    ...
    y s1f "What do we need to talk about?"
    ...
    y s1h "It's going to take a bit of time to explain, do you have anything to do today?"
    mc "No. I want to listen to you."
    show yuri s1g at t11 zorder 2
    "She takes an apprehensive face before she speaks, almost afraid of what to say."
    y "..."
    play music t9
    y s1t "[player], do you remember when I first showed you my cuts?"
    "My spine begins to tingle when I hear that."
    mc "Yeah."
    y s2h "And when I thought about breaking up..."
    mc "..."
    ...
    y s1h "Everything around us is changing."
    y "When the club was announced to be cancelled, it opened my eyes to the truth."
    y s1h "The club will be gone, but what about the rest of you, the friends I made along the way?"
    ...
    y s2t "Hope that I could finally be happy with people other than myself."
    y s2v "It's so weird and difficult to explain, because I had always wished to be alone."
    ...
    y s3w "And what's the result?"
    y "I go back to relying on my burdens."
    y s3v "This pain, it's ironically the only relief I have with myself."
    ...
    "..."
    y s1g "I... I should be going home now."
    y "I need some time alone."
    mc "Oh... okay."
    y s1h "Goodbye, [player]."
    mc "Bye, Yuri."
    show yuri at thide zorder 1
    hide yuri
    ...
    "Maybe if I can show we can live beyond the literature club, that we can love her and understand her throughout life..."
    ...
    "But she it might be something she needs to hear, from all of us."
    "Before that, I'll talk with Sayori when I see her tomorrow, perhaps just have her talk to Yuri first."
    "If that doesn't work, then we may have to move to more... deeper measures."
    ...
    s 1k "Yeah, she just seems so upset about something."
    ...
    s 1c "Did anything serious happen? Like relationship threatening?"
    ...
    mc "I want you to talk to Yuri today, and maybe see if you can get through to her or cheer her up."
    mc "I think I've done all I can on my own, so I thought maybe you can get through to her."
    ...
    with wipeleft_scene
    show sayori 1a at t11 zorder 2
    "By the time our discussion ends, we're already inside the school."
    ...
    "I'm going to have to tell the club about Yuri so they can really understand what's going on."
    ...
    n "Oh, it's nothing."
    n "Monika just said something she really shouldn't have."
    n 4y "Honestly Monika, I didn't know you were like that."
    ...
    m "It's gonna take a lot more than simple begging to stop me."
    show monika 4j at t21 zorder 2
    ...
    show natsuki 5s at f31 zorder 2
    "We all have a laugh from that."
    "Well, all except Yuri."
    ...
    m "Okay everyone, I think we had our fun for today."
    m "I call this meeting to an end."
    show monika at thide zorder 1
    hide monika
    ...
    stop music fadeout 2.0
    play music t9
    y s4b "I just need to know... how?" 
    y "How can you be so joyful when you can't see a future for yourself?"
    y s3t "Aren't you afraid at all about the future? How it could be like before you met everyone?"
    ...
    mc "But a part of me felt if I can get through another day just so I could see you and the others, then so be it."
    mc "And that, for me at least, makes me happy with everything else, in a way."
    mc "Even though this might not be the best life advice, that's how my view on things."
    ...
    "They have to..."
    show monika s4b at f41 zorder 3
    show natsuki s1a at t42 zorder 2
    show sayori s1a at t43 zorder 2
    show yuri s1g at t44 zorder 2
    m "Okay everyone, that'll be it for today."
    m "Other than that, please be excited for the party tomorrow."
    show monika s4b at t41 zorder 2
    show natsuki s2m at f42 zorder 3
    show sayori s1o at t43 zorder 2
    n "Sayori, are you alright? You're staring past us."
    show natsuki s2m at t42 zorder 2
    show sayori s1o at f43 zorder 3
    s "I have been preparing my whole life for this."
    show natsuki s2g at f42 zorder 3
    show sayori s1o at t43 zorder 2
    n "Sayori, get a hold of yourself!"
    n "It's just a party!"
    show natsuki s2d at t42 zorder 2
    show sayori s5a at f43 zorder 3
    s "Sorry, I'm just so excited!"
    show natsuki s2d at f42 zorder 3
    show sayori s5a at t43 zorder 2
    ...
    y s1f "Oh, I didn't think Sayori would make you involved in this as well."
    ...
    y s1s "Okay then, I'll see you tomorrow."
    y "Bye, [player]."
    mc "Bye, Yuri."
    show yuri at thide zorder 1
    hide yuri
    show monika s1a at t31 zorder 2
    show natsuki s1a at t32 zorder 2
    show sayori s1a at t33 zorder 2
    ...
    show sayori s1b at f33 zorder 3
    s "Yeah, you said you had to tell us something."
    show sayori s1b at t33 zorder 2
    show monika s1d at f31 zorder 3
    m "Wait, what's this thing that's so important?"
    m s5b "With Yuri out of the room, I'm guessing you're throwing a special surprise for her tomorrow."
    m "Way to make it about her."
    show monika s5b at t31 zorder 2
    mc "That's not really--{nw}"
    show natsuki s4e at f32 zorder 3
    n "Yeah [player], this is supposed to be about all of us."
    show natsuki s4e at t32 zorder 2
    mc "It's just that--{nw}"
    show sayori s2c at f33 zorder 3
    s "Wait guys, I think it's actually serious." 
    s "He was pretty upset when he mentioned it."
    show sayori s2c at t33 zorder 2
    mc "You're right, it's--{nw}"
    show natsuki s4w at f32 zorder 3
    n "Well, spill it out. What is it that only us three can hear-{nw}"
    stop music fadeout 2.0
    show natsuki s4w at t32 zorder 2
    mc "Yuri cuts herself!"
    show monika s1d at t31 zorder 2
    show natsuki s1p at t32 zorder 2
    show sayori s1g at t33 zorder 2
    $ n_name = "All"
    n "..."
    show monika s1o at t31 zorder 2
    show natsuki s1q at t32 zorder 2
    ...
    mc "She likes to cut her arms to feel the pain..."
    mc "To feel something."
    show sayori s1k at f33 zorder 3
    play music t9
    s "..."
    s "I-I never knew."
    show sayori s1k at t33 zorder 2
    ...
    show monika s1d at t31 zorder 2
    mc "Yeah, I know..."
    show monika s1p at t31 zorder 2
    mc "..."
    show natsuki s5q at f32 zorder 3
    n "So, have you done anything about it?"
    show natsuki at t32 zorder 2
    mc "I've been trying to help, and I thought I was, but--"
    show natsuki s5h at f32 zorder 3
    n "But what? It sounds like you're doing a pretty lousy job at being a boyfriend."
    show natsuki s5g at t32 zorder 2
    show monika s1i at f31 zorder 3
    m "Natsuki, you don't need to be spiteful towards [player]."
    show natsuki s1h at f32 zorder 3
    show monika s1i at t31 zorder 2
    n "But Yuri's hurting, and it doesn't look like [player] is doing a darn thing about it."
    show natsuki s1h at t32 zorder 2
    show monika s1i at f31 zorder 3
    m "I'm sure he's done everything he could so far."
    m "You know that he loves her."
    m "Otherwise, what was the point of telling us if he didn't care?"
    show natsuki s5u at f32 zorder 3
    show monika s1i at t31 zorder 2
    n "...I suppose you're right."
    n "It just... sucks, you know?"
    n "She had this problem the whole time, and none of us knew."
    show natsuki s5u at t32 zorder 2
    mc "None of you could've known, she kept it pretty well hidden."
    mc "..."
    show monika s1f at f31 zorder 3
    m "So, what can we do to help?"
    show monika s1f at t31 zorder 2
    mc "Monika?"
    show monika s1g at f31 zorder 3
    ...
    show monika 5a at t21 zorder 2
    show natsuki at t22 zorder 2
    "I can hear Monika snickering in the background."
    "She probably saw Sayori take the cupcake."
    ...
    y "I've been thinking a lot over about what you told me a few days ago."
    ...
    y "Um, what's going on?"
    y "Was there something we were suppose to do first?"
    show sayori at thide zorder 1
    hide sayori
    show monika at thide zorder 1
    hide monika
    ...
    y 3n "W-What are you talking about, [player]?"
    ...
    m "We already know, Yuri."
    m "[player] told us yesterday about it."
    show monika 1d at t44 zorder 2
    show yuri 3p at hf43 zorder 3
    y "Wh-What?! Why?!"
    y "Why did you tell them?!"
    y "It was suppose to be a secret!"
    y 3o "I'm not ready for others to know."
    y 3n "I'm not ready to deal with others thinking of me like... like a freak!"
    show yuri 3o at t43 zorder 2
    mc "Yuri, I had to tell them."
    mc "What you told me on Tuesday really frightened me."
    ...
    show yuri 3o at f43 zorder 3
    y "But... but not like this!"
    y "It's all so sudden!"
    y "I-I need to go, b-but..."
    y "W-Where do I go?"
    ...
    scene bg black
    with dissolve_scene_full
    "The silence in the room hung heavily as Yuri grabbed hold of her sleeve and slowly unraveled her arms."
    scene bg club_day
    with wipeleft_scene
    show monika 1f at t44 zorder 2
    show sayori 1g at t41 zorder 2
    show natsuki 1n at t42 zorder 2
    show yuri 5bc2 at t43 zorder 2
    play music t9
    "..."
    ...
    y "..."
    y 5bc2 "You all think I'm a freak now, don't you?"
    ...
    y 5bc2 "But after this school year with all of you, I don't want to ever go back."
    ...
    show monika 1r at f43 zorder 3
    ...
    show sayori 1g at f21 zorder 3
    ...
    show sayori 1t at t21 zorder 1
    ...
    show monika 5a at t44 zorder 2
    show sayori 3o at f41 zorder 3
    s "Wait, what are you two talking about?"
    show sayori 3o at t41 zorder 2
    ...
    n "You mean, {i}former{/i} club president."
    show natsuki 2d at t42 zorder 2
    ...
    show monika 1a at t44 zorder 2
    show sayori 2n at f41 zorder 3
    s "Wait a minute, if Monika is no longer the president, does that mean I become president?"
    show sayori 2n at t41 zorder 2
    show monika 1l at f44 zorder 3
    m "You know what Sayori, sure. You're the club president now."
    show monika 1l at t44 zorder 2
    show sayori 4r at f41 zorder 3
    s "Yaaaaay!"
    s 2r "Well, come on guys, let's get pumped!"
    s "I even have the perfect song right now!"
    show sayori at thide zorder 1
    hide sayori
    show monika at thide zorder 1
    hide monika
    ...
    show yuri s1a at t41 zorder 2
    show natsuki s1a at f42 zorder 3
    show sayori s1a at t43 zorder 2
    show monika s1a at t44 zorder 2
    n "Well, I'll be seeing you all later."
    n s1d "I have some things I need to attend to, but once I come back I'll be more vicious than ever before!"
    show natsuki at thide zorder 1
    hide natsuki
    show yuri s1a at t31 zorder 2
    show sayori s1a at t32 zorder 2
    show monika s1a at t33 zorder 2
    "Natsuki then walks confidently out the door."
    "I wonder how much more powerful she'll get."
    show sayori s1q at f32 zorder 3
    s "Today was really fun! We have to try something like this again."
    s "Maybe at my place! You all know where it is, after all."
    show sayori s1q at t32 zorder 2
    mc "Maybe Sayori, maybe."
    "As she made her way toward the door, she put up both hands, waving at the rest of us."
    show sayori s4r at f32 zorder 3
    s "Byyye!!!"
    show sayori at thide zorder 1
    hide sayori
    show yuri s1a at t21 zorder 2
    show monika s1a at t22 zorder 2
    "Sayori doesn't go hopping out like the door like I expected, but she looks a lot happier."
    show monika s5a at f22 zorder 3
    m "This has been one interesting year, hasn't it Yuri?"
    show monika s5a at t22 zorder 2
    show yuri s1c at f21 zorder 3
    ...
    show yuri s1c at t21 zorder 2
    show monika s1k at f22 zorder 3
    m "Haha."
    m s1a "Yuri, make sure to never stop being as great as you are."
    m "And [player], make sure you love her like no one else in this reality."
    mc "Sure will."
    show monika s1k at thide zorder 1
    hide monika
    show yuri s1a at t11 zorder 2
    ...
    y s1f "Um, [player]..."
    mc "What is it Yuri?"
    y s1s "Well, I was just wondering if, before we leave, that we can sit by the wall one more time."
