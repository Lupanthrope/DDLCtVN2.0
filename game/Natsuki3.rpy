...
#Start Scene 6 - Out of Water
    ...
    "I consider slowly slipping out of my bed so as not to disturb her, but the second my feet touch the floor, the girl beside me rises like a pheonix from the ashes."
    ...
    n 4by "Good boy. Now lift me from the bed and place me to my feet upon the ground."
    ...
    "Then, in the spinning’s stead I begin to rock Natsuki aggressively back and forth, and start counting."
    mc "One..."
    n 4bp "[player]!"
    mc "Two..."
    ...
    menu:
        ...
        "Ask Natsuki about her bad dream":
            ...
            hide natsuki
            "As she says that, she finished making our eggs and rice, then cleans up the counter a little bit, albeit rather sluggishly."
            ...
            n 1bt "So,{w=0.25} uh,{w=0.25} this dream I had..."
            ...
            mc "Yeah, of course."
            mc "I love you, too."
            n 1bq "Well... I love you so much, that sometimes I have a lot of bad thoughts about... {w=0.5}us."
            n 1br "The worst parts of my conscience make me wonder if you're just dating me for my body." 
            n "O-or if you're just staying with me because you pity me."
            mc "Natsuki, you know that isn't-{nw}"
            n 1bm "[player], I know, just let me finish, please."
            "I nod and let her continue."
            n 1bu "This morning, I...{w=0.25} dreamt that you left me..."
            n 1bm "For Monika."
            "{i}Huh?{/i}"
            mc "Huh?"
        ...
        "Forget about it and enjoy breakfast":
            ...
            n 1bx "Nat's the name, don't wear it out."
            mc "Ahahaha, that's what I thought."
            n 4by "Whatever dummy, it's not my fault your nickname game is trash."
            #End scene 6b
...
#Start scene 7a - Movie Date
    ...
    "Sometimes I am amazed awt how much of a prick I can be..."
    ...
    mc "Deal"
    n 4bd "Great!"
    n 4bb "Oh, we should probably start eating our breakfast, it's getting cold."
    show natsuki at thide
    hide natsuki
    "We finish eating and get to cleaning, all while talking about random things we saw on the internet."
    "The weather forecast announces that the morning rain clouds will clear out by 1 pm."
    ...
    "We should do something before this evening's screening."
    ...
    mc "And don't assume I'll let this centernce slide without a punishment."
    n 2bk "Wh-{nw}"
    n 2bn "HEY! STOP-{nw}"
    n 2bz "BWAHAHAHAHAHAHAHAHAHAHA-!{nw}"
    ...
    "She then comes back at me with a punch worthy of Mohammed Ali, straight to my shoulder."
    ...
    "We should get headed to the cinema before the streets get unsafe."
    "We enter the nearest train station and head back downtown."
    "On our wayt there, I notice a familiar face."
    "Or should I say, familiar purple hair."
    scene bg subway_night_lights
    with fade
    ...
    y "..."
    "Damn, looks like the cheery approach didn't work."
    "I look at Natsuki, hoping she can hekp out in this situation, but she seems as lost as me."
    y "..."
    y n1bq "What are you doing here?"
    ...
    mc "Oh, I was just... just going to the movies with Nats!"
    mc "That's all."
    y n1bt "Oh, you use nicknames now? How cute."
    y n1bw "{w=0.5}And disgusting."
    "Whoops."
    "Didn't mean to say that."
    "I guess I was acting too cool."
    "And it turned out to be a big mistake."
    "I can feel Natsuki's eyes weighing down on me."
    mc "Yuri, I don't think the law forbids using nicknames."
    mc "And also, why are {i}you{/i} here?"
    mc "Were you perhaps following us?"
    y n3bp "Eh... What, I- No!"
    y n2bo "I was supposed to go see \'(insert movie name)\', and I just ran into you."
    "She keeps acting as if Natsuki wasn't here."
    "It's infutiating."
    mc "Hey, I'm not all alone."
    show yuri n1be at t11 zorder 2
    "I gesture towards Natsuki, forcing her to react."
    show yuri n1be at t21 zorder 2
    show natsuki n1bu at f22 zorder 3
    n "H-hi, Yuri..."
    show natsuki at t22 zorder 2
    show yuri n1bh at f21 zorder 3
    y "You two are annoying me"
    show yuri at t21 zorder 2
    mc "Is the whole world annoying to you?"
    show yuri n1bg at f21 zorder 3
    y "..."
    show yuri at t21 zorder 2
    mc "Does {i}friendship{/i} mean anything to you?"
    show yuri n1bf at t21 zorder 2
    "I can see that these words startled her."
    show natsuki n1bf at f22 zorder 3
    n "[player]!"
    show natsuki at t22 zorder 2
    show yuri n1br at f21 zorder 3
    y "I don't want a forced friendship."
    show yuri at thide
    hide yuri
    show natsuki n5bx at t11 zorder 2
    ...
    scene bg station_night
    with wipeleft_scene
    show natsuki n5bg at t11 zorder 2
    mc "I'm sorry, I-"
    n n5bb "Dont worry."
    n n5bn "I-I'm sorry too."
    n n5bs "Its kinda my fault that- that Yuri and I-"
    ...
    scene bg road_night
    show natsuki n2bu at t11 zorder 2
    ...
    show natsuki n12bf at t11 zorder 2
    ...
    menu:
        "Offer to take Natuski home":
            #Start scene 7a-I
            $ karma += 1
            mc "Hey, Natsuki, why don't we just... go home early?"
            n "[player], I'm fine, I promise."
            mc "Natsuki, can you tell me the truth? I can tell when you aren't fine."
            "Natsuki looks at me blankly and takes my ahand, then hugs me."
            n "I just don't want to waste the money you spent on tickets."
            mc "It's not important, Nats."
            mc "How about we stop somewhere to eat before we go home?"
            "Natsuki releases a small snicker, happy at the offer."
            n "I'd like that."
            show bg road_night
            with wipeleft_scene
            "Natsuki and I leave the movie theater and stop at a vendor selling takoyaki and pork buns."
            "We have a nice walk home while we eat and take our minds off of what had happened."
            ...
            n "Can things in my life even improve..."
        ...
        "Watch the movie anyway and hope she feels better":
            ...
            "Nats will have the appetite of a lion."
            #End Scene 7a-II
...
#Start scene 7b - Dinner Date
    ...
    "A few hours ago, I told Natsuki that I was going to take her out, since I wanted to show that I appreciate all the work that she does for the house."
    ...
    "Overwhelmed at the prospect of dining in such a luxurious place."
    ...
    n "Aw, yes! Thanks for bringing my here, [player]!"
    n "I haven't gotten to eat her since I was, like, 7."
    show natsuki 4bj
    ...
    n 4be "If you let the punch of a 4-foot-11 girl be the death of you then I think you're the uncool one here."
    mc "Keep that up and you're paying for your tonkotsu."
    n 1bx "I wanted shoyu anyway!"
    show natsuki 1ba
    ...
    n "Extra spicey for me!"
    mc "You sure you can handle that?"
    n 5bg "I can handle it."
    n 5bl "Question is, can you handle me handleing it?"
    "I genuinely have no idea what she means by that, but I answer anyway."
    mc "You better believe it!"
    "After we place our orders, Natsuki and I pick a table for two with the sceninc view out the window."
    ...
    n "You'd think there'd be a dinner ruch on a Saturday afternoon."
    ...
    n 1be "Since forever!"
    n 4bq "Not that I have to explain myslef to you."
    ...
    n 1bq "I just wanted to have a chance to escape the depressing monotony of everyting we'd been going through."
    ...
    "While it's still hard for her to talk about at great legnths, it's good that she's making progress."
    ...
    n 2bk "I think it was the thing I ordered, maybe a little less spicey."
    ...
    "Natsuki andI chat for a few more minutes before our food arrives at the table."
    ...
    mc "And every time you speak to the girls, you have to close every sentence with \'Nye~!\'"
    show natsuki 1bx
    ...
    "Seem's like the pressure's already on."
    ...
    n 5bf "Nuh uh bozo! You're not getting any \'Nye~'s\' out of me!"
    show natsuki 1bu
    ...
    "A few minutes later I look at her bown and it's nearly empty."
    ...
    n 3bq "My tummy hurts, please call and ambulanc ebefore I explode."
    mc "Don't be dramatic."
    "I laugh then walk over to Natsuki and give her a kiss on the head."
    n "I feel a little better now."
    ...
    scene bg house
    with wipeleft_scene
    "Once we reach our front door I unlock it and Natsuki sooms past me in a panic."
    ...
    "I chuckle at the thougt."
    "Sayori and I have been close for along time, and we do regularly communicate with each other."
    ...
    "Admittidly I kind of miss it, but when one person in a platonic relationship become romantic with somebody?"
    "Well, unfortunately, that \"just friend\" ends up becoming the number 2."
    ...
    mc "Always, Natsuki."
    n "So...{w=0.25} I'm really happy that you took me out for dinner and took me shopping, but..."
    n 1bs "I really...{w=0.5} didn't have a good time." 
    ...
    n 1br "I wasted you rmoney {i}twice{/i}. and now who knows when I'll get to eat there again?"
    n 1bu "You probably never wasnt to take me back there after the way I screwed everything up."
    show natsuki 12bf
    "Natsuki starts to sob lightly, then mumble under her breath."
    n "...all my fault..."
    "{i}What did she say?{/i}"
    n "It's all my fault."
    "{i}No, she can't be thinking thsi way again.{/i}"
    ...
    n 12bb "I don't think I'll ever reall ybe okay."
    ...
    if (tens_check == "S" and jerk == False):
        "Hell, she's told me herslef that me and Natsuki's relationship hurts her and makes her feel worthless."
    ...
    menu:
        "Tell Sayori what's bothering me":
            ...
            mc "She ended up getting hers extra spicy--{nw}"
            ...
            mc "And she was blaming herself for ruining out day."
            ...
            mc "She...{w=0.5} told me she doesn't think she can ever be happy."
            s 1bv "What?"
            ...
            mc "Shes...{w=0.25} been through a lot."
            ...
            "Letting these feelings out to Sayori is mmaking me even more emotional that when I was thinking about it by myself."
            ...
            s 2bl "If you were my boyfriend I would have an earier time waving the rain clouds away."
            ...
            s "But if Natsuki has you, and doesn't think that oyu can make her feel the same way, then..."
            s 1bh "Well..."
            s 2bj "Let's just say, I think you deserve better than that."
            show sayori 2bj at f11 zorder 2
        ...
        "Shrug it off and change the subject":
            ...
            s 2ba "Do you wanna walk down to the pong and sit together for a while?"
            mc "Honestly, Sayori..."
            ...
            scene bg park
            with wipeleft_scene
            "Sayori and I walk to the pond a few blocks down from our neighborhood and I try yo remember the last time we've gone together."
            "We must've been kids."
            mc "Hey, Sayori, do you remember how old we were the last time we came to this pond?"
            mc "Must've been 11 or 12, right?"
            show sayori 2bc at t11 zorder 2
            s "Actually, no, don't you remember, we ran into each other that summer when we were 15!"
            mc "Oh, my god, I nearly forgot about that!"
            mc "That was a lot of fun, from what I remember."
            s 3bq "It was, we played soccor together, and then I dared you to go swimming iun the water-{nw}"
            mc "And then I said I would, but only if you went in with me-{nw}"
            ...
            mc "Well...{w=0.5} I kind of know what it's like now."
            mc "Probably not the the exact degree that you feel, but I'm starting to feel it."
            s 1bh "[player], you need to know somethng."
            ...
            s "Because you're a speacial person."
            mc "Do you really feel that way?"
            show sayori 3bd at f11
            "Sayori scootches toward me and alarmingly places her head on my shoulder."
            ...
            s 1bh "I feel like this magiv between us has been gone for a while."
            s "But it started to come back when you joined the club."
            ...
            "If I keep living in the past with mine and Sayori's chilhood memories, then Natsuki and I will never reach the heights we can reach."
            ...
            "Nop matter what Natsuki says I can't do, I have to do everything in my power to save her, to save {i}us{/i}."
...
#Start Scene 7c - Fun Date
    ...
    mc "How come?"
    n 1bn "Let's just say elephant ears plus pirate ship rise equals a bad time."
    ...
    mc "Awesome!"
    show natsuki 1bh
    mc "In the meantine, do you want to have that other 'fun night' you were alluding t-{nw}"
    n 1by "I'm hoinh yo ho read a manga."
    show natsuki at thide
    hide natsuki
    mc "Okay, yup, that's uh... okay."
    scene bg house
    with fade
    "Several hours later, Natsuki and I get ready to leave for the carnival."
    ...
    show natsuki s1bk
    mc "Hey, you're one to talk! You literally baked cupcakes last night that were identical to the ones on page 56 of volume 12 of Parfait Girls."
    n s4by "And you know those numbers, how?"
    mc "...{w=0.25}because I've been reading too much manga."
    ...
    show natsuki s4bo
    "Natuski and I look about eight feet to our left and see a literal pile of vomit."
    ...
    "Hopefully we don't get spun into the next toqn over with him operating this ride."
    ...
    "This back and forth goes on for about 120 full seconds, and by the point we've reached a peace agreement between, our two camps, the ride ends."
    show natsuki s1ba
    mc "So little progress was made in those two mintues, I think my head hurts."
    ...
    n "Carnival rides are always more fun at night! Think about all the lighs that come on!"
    mc "Yeah well..."
    show natsuki s5bq
    ...
    n s5bq "..."
    n s4br "This is the hardest choice I've ever had to make."
    ...
    show natsuki s4bo at t22 zorder 2
    ...
    n "Uuuu..."
    n s12bc "[player]...{w=0.25} do you want to feed me my stupid Oreo?"
    ...
    n "...Monika..."
    mc "Monika?"
    n s12be "F...{w=0.25}fuck you...Monika"
    show natsuki at thide
    hide natsuki
    ...
    n n1br "I...{w=0.5} wasn’t gonna say that."
    mc "I don’t believe that. Before you passed out I heard what you said."
    mc "What do you have against Monika."
    n n1bq "..."
    n n1bh "I don't have any-{nw}"
    mc "Natsuki, you bettwe tell me the truth."
    n n1bu "..."
    n n1br "...Monika..."
    ...
    n n42be "And then that thing that pissed me off the most was when she said I was taking you for granted by not letting you feed me! What is her problem?!"
    mc "Natsuki, relax, she was just joking!"
    n n4bw "That's bullshit. Saying 'I’m joking' is just the way someone like Monika thinks she can get away with insulting you!"
    n n4br "I don’t care how charming she is, I see through her just the same."
    n n42bi "But she doesn’t know anything about how much I value you! How does she have the audacity to say something like that after all I’ve been through?!"
    mc "Hey, Nats, come on. Monika’s not as devious as you’re letting on."
    n n42bg "Why? Why are you on her side right now?"
    mc "I’m just saying...{w=0.5} I think you’re overreacting. Monika did nothing wrong."
    n n42bc "Oh yeah? Well if Monika hadn’t shown up, she wouldn’t have given me her Oreo. If Monika hadn’t shown up, we wouldn’t have ridden another ride."
    ...
    mc "You're welcome."
    mc "Well, it's getting late now, I think we outh to get some sleep."
