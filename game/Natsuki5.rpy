...
#Start Scene 9 - Cocoa
    ...
    n "She’s been acting a bit strange lately."
    ...
    with dissolve_scene_full
    "We walk for 15 minutes toward the mall."
    ...
    "\"Due to technical difficulties, the 50th Anniversary Christmas Lights have been cancelled today. We apologize for any inconvenience. -  Management\" "
    ...
    with wipeleft_scene
    "Natsuki drags me towards the station."
    scene bg subway_afternoon
    with wipeleft_scene
    "We jump on the first express train to the city."
    ...
    "We reach our destination, along with 50 other people who got off our train."
    ...
    hide natsuki
    mc "Ow, what the heck!"
    "I’m about to tell Nat off, but I see her eyes glittering as she looks at the lights around us."
    ...
    mc "It’s pretty late though, you might spoil your dinner."
    n 5bx "Get me a churro, dummy, or {i}you’re{/i} not {i}getting{/i} any dinner."
    mc "Hmph, fine."
    show natsuki at thide
    hide natsuki
    ...
    scene black
    with fade
    "Natsuki and I take the next train home, and arrive back at our house at 9:00."
    scene bg living_room_night
    show natsuki n1bv at t11 zorder 2
    n "I’m soooo tired, [player]."
    mc "Really? I was just about to make dinner for us."
    n n4bb "Remember that churro you got me? Yeah, that was my dinner."
    n "I’m calling it a night after I shower."
    mc "Well, I guess I’ll just prepare something small for myself."
    mc "You’re sure you aren’t hungry?"
    n n2bh "Well, I could eat, but...{w=0.25} er, nothing."
    mc "What is it?"
    mc "Do you not trust me to make a good meal?"
    n n2bs "Um...{w=0.25} I’m gonna go...{w=0.25} take that shower now."
    ...
    "Maybe I should’ve thought of that earlier but I’ve been...{w=0.5} busy."
    "It’s about 11 in the morning, and I’m still yet to get out of bed."
    ...
    n 2bs "And it was...{w=0.25} really relaxing."
    ...
    n 4bj "Well, actually, I was going to ask you if you wanted to come with me."
    mc "A-are you sure?"
    n 5bd "Heh, why, are you scared of meeting your girlfriend’s mom?"
    ...
    n 1bj "[player], come on, you could never."
    n 4bh "My dad...{w=0.5} he’s troubled, unlike you."
    n "It’s important and intimate, yeah, but there’s no one more important to me than you, and no one I’m more comfortable being intimate with than you."
    n 1ba "I want you there with me tomorrow."
    n 2bl "And besides, you’ll be able to have an amazing lunch prepared in spirit by my mom, the only person I ever knew who was a better cook than me!"
    n "Who says no? Hehehe~!"
    ...
    n 1bn "Well...{w=0.25} truth be told I just don’t like to talk much about my mom."
    n "Don’t get me wrong, I love her, but that’s exactly why I don’t like talking about her."
    n 2bm "The longer I do, I...{w=0.25} break down, eventually. And I don’t like you to see me like that."
    ...
    "I look at the photo and it’s like I’m looking at Natsuki. She looked just like her."
    ...
    n 4bn "You were always...{w=0.25} so good...{w=0.25} at cooking for me..."
    "..."
    "I scooch in closer to Natsuki and hug her."
    n 2bj "*sniffle* Well, uh, anyway, I think it’s time for lunch. Right, [player]?"
    ...
    "Natsuki puts an equal amount of noodles on each plate, then hands me my food."
    "Then, without any regard for cleanliness or properness she cracks hers open, then takes a bunch of noodles and..."
    ...
    mc "But...{w=0.25} when I met Natsuki...{w=0.5} everything changed for me."
    ...
    n 12bi "Or...{w=0.25} with a close friend, or a boyfriend, or..."
    $ y_name = "?"
    y "With your own father?"
    mc "...!"
    ...
    $ y_name = "K"
    y "Natsuki..."
    show natsuki 42ba at t11 zorder 2
    n "P-p-p..."
    n "Dad."
    n 42bb "I... didn’t think I’d see you here. I thought you’d be..."
    n "Doing..."
    n 42bc "Or that you’d be working at... er..."
    y "I guess we’re at the point now where neither of us have any idea what the other is even up to, huh, Natsuki?"
    n 12bb "Dad..."
    n 12ba "What are you doing here?"
    y "I can’t come see my wife on her birthday?"
    y "I thought you’d understand better than anyone how much this day means to me."
    n 42be "Yeah? Then why did you miss it last year?!"
    show natsuki 42bd
    y "What choice did I have, Natsuki?!"
    y "I’m stuck, I have to work so many long hours at so many shit-paying jobs to provide for you!"
    y "Everything I did and everything I didn’t do was all for you, Natsuki!"
    n 12bc "That’s bullshit, and you know it, Dad!"
    n "When mom died you didn’t give a single shit about me!"
    ...
    n 12ba "So please, keep telling me that everything you did was to provide for me."
    "..."
    y "Natsuki..."
    y "You're right, okay?"
    y "I did resent you. I did blame you for your mother's death."
    y "I... wasn't well, then."
    n 42bd "..."
    n 4be "Are you trying to say that you’re somehow better now?"
    y "Natsuki...{w=0.5} I’m trying. For you, I’m trying."
    n 5bf "What changed all of a sudden? Why do you think now I’d believe that you wanted to do anything for me?"
    y "Do you want to know what changed? Do you really want to know?"
    n 5bw "Yes, Dad, fucking tell me!"
    y "{i}IT WAS BECAUSE I ACTUALLY LOST YOU THIS TIME.{/i}"
    n 5bi "..."
    y "..."
    mc "..."
    y "Natsuki... I can’t believe the man I had become in the last ten years."
    y "For ten long years I spent every day wishing that you’d be out of my life."
    y "But... the minute you were actually gone was when I woke up."
    y "It’s when I realized that I was living the most despicable life any man could live."
    y "Truth be told, Natsuki, I had no idea where to go after you left."
    n 5bq "Stop saying \"I left,\" you kicked me out!"
    show natsuki 5bs
    y "YOU THINK I DON’T REALIZE THAT?"
    y "YOU THINK THAT ISN’T SOMETHING THAT’S BEEN EATING AWAY AT ME FOR THE ENTIRETY OF THE LAST THREE MONTHS?"
    y "..."
    y "Natsuki, I didn’t know what to do with you gone. I didn’t know where you went, or how I could reach you again, and even if I did, what could I say to you?"
    y "So...{w=0.25} every week since you’ve been gone I’ve...{w=0.5} come here, to see your mother."
    n "..."
    n 5bm "Really?"
    show natsuki 5bn 
    y "Yes. Talking to her has been a reconciliation of sorts for me."
    y "I’d rack my brain trying to think of all the sins I've committed unto you both."
    y "The drinking, the cursing, the yelling..."
    y "The hitting..."
    y "Natsuki, the more I talked to your mother about the things I’d done wrong, the more I realize how much I’ve made your life hell for the last ten years."
    y "Because of that... I’ve quit drinking, and I’ve tried getting back on my feet."
    y "I’ve been looking for a better job so I could refurnish the house and stock our refrigerator."
    y "So that... when...{w=0.25} {i}if{/i} you ever came home, you’d have a better place to live."
    n 5bs "..."
    y "Natsuki, I know that what I’ve done to you is unforgivable. I can hardly forgive myself."
    y "But... if you’ll give me the chance to prove that I’ve wanted to change-{nw}"
    n 5bb "I’m going to stop you right there, Dad."
    ...
    n "If you actually think what you’ve done can be erased, then you’re also the stupidest person I’ve ever known too."
    y "Natsuki, please, don’t say things like that..."
    y "Please, not in front of your mothe-{nw}"
    n 4bp "{i}DON’T BRING MAMA INTO THIS, OKAY?{/i}"
    n "{i}THIS ISN’T ABOUT HER. THIS IS ABOUT ME AND YOU.{/i}"
    n 4bo "You’ve scarred me in so many more ways than I can describe, Dad."
    n 5bq "When you hit me for the first time...{w=0.5} nothing made me feel less human."
    ...
    n "Not that it’s ever been you with the way you’ve treated me."
    ...
    y "..."
    y "I think Ive said my piece."
    show natsuki at thide
    hide natsuki
    "Natsuki’s father steps between us and walks up to his late wife’s headstone."
    y "(Kaiya, I’m sorry for all the wrong I’ve done. I wish I could change the past. But all I can do is say I’m sorry again.)"
    y "(Happy birthday, my darling. I hope our princess comes home someday.)"
    ...
    "I see him then unveil that the picture was folded all along."
    "He then walks toward Natsuki, getting closer to her than she seems comfortable with, and hands her the photograph."
    y "Just remember... there was a time where I wasn’t the monster you see me as."
    n "..."
    $ y_name = "Yuri"
    "The next moment, he’s gone, completely out of sight."
    "I think about it, and I didn’t even get a single word in. He didn’t even acknowledge me."
    ...
    n "Do you...think...I was too hard on him?"
    ...
    menu:
        "Yes":
            ...
            mc "Before today I had this picture of him and his personality in my head, but after seeing him today..."
            mc "I guess I was expecting someone a little less...{w=0.25} human."
    ...
    n 5bs "..."
    n "I see."
    n 1bj "I think I needed to hear that from you to know for sure."
    ...
    n 1bd "I... put this picture here last year."
    n "I could’ve cut it and deleted any trace that he was in this picture the whole time too, but..."
    n "I would’ve felt too guilty because... he’s my dad, and... deep down..."
    show natsuki at thide
    hide natsuki
    ...
    "She told me about the first time her mom bought her a manga and they’d read it together."
...
#Start Scene 9a - Cocoa (Good)
    ...
    "Suddenly, I realise that I forgot about what I was supposed to do."
    ...
    mc "Hey Nats, good morning. I brought us something warm to drink and eat for breakfast so we don’t have to go out of the warm blankets."
    ...
    n d1bn "You really didn't have to..."
    mc "Don't worry about the small stuff."
    ...
    n mblac "You know, see the snow and maybe some of the decorations?"
    n mblag "My family and I used to do that befo-{nw}"
    ...
    n mblaj "Your hand is warm, [player]. Really warm..."
    "A few moments pass."
    show natsuki at thide
    hide natsuki
    ...
    mc "You ready?"
    mc "Cuz I'm ready."
    "I didn’t think I could manage a worse Texan accent than this."
    n "Yeah, I'm ready."
    n m1bd "Then let's go"
    scene black
    with fade
...
#Start scene 9b - Cocoa (Bad)
    ...
    n m1bg "Pretty much the same as always."
    ...
    n m4bd "Yeah that sounds great! But I can make it myself, you just focus on the breakfast."
