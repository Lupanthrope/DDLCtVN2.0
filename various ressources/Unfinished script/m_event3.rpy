label m_event3:
    ...
    scene bg schoolgates with wipeleft_scene
...
#C5a- Old Confession scene spot - moved to E2
#C6 - Actually learning some stuff
    stop music fadeout 1.0
    play music tmonika #<-- We may want an "OK Everyone!" track but with an acoustic for MC rather than Monika's piano
    ...
    show monika 1ba at t11 with dissolve
...
#C9
    ...
    scene bg livingroom_evening with wipeleft_scene
    ...
    scene bg residential_evening with wipeleft_scene
...
#C10 - Confrontation
    ...
    scene bg sayori_bedroom_sunset with wipeleft_scene
    show sayori 1bv at s11
    ...
    menu:
        ...
        "Pull her into a hug":
            show sayori 1be at face with dissolve
            $ c10e = 1
    ...
    show sayori 1bq at face with dissolve
    if c10e == 1:
...
#C11
    ...
    show yuri at thide, hide yuri
    show sayori at thide, hide sayori
    ...
    scene bg h_corridor with wipeleft_scene #<-- May want to import DDLC+ Staircase here
    ...
    show natsuki 12f at face with dissolve
    play sound fall
    ...
    n 3d "See ya, [player]."
    show natsuki at thide, hide natsuki
    ...
    show monika 1e
    mc "Okay.."
    show monika 1j at tll with dissolve
...
#C12
    ...
    t "Alright, everyone, sorry I’m late."
    t "Actually, there’s only about ten minutes left of the lesson."
    t "Staff meetings are a pain, but regardless I’m here now."
    ...
    m "I’ve got this."
    t "Monika, are you playing Battleships?"
    m "Yes, Miss, I am, with [player]."
    t "I don’t need to remind you that using the school network for non-educational purposes is against the rules, do I?"
    ...
    t "That’s very noble of you, Monika."
    t "Good luck with your exam today, [player]."
    t "I can imagine it takes a lot to impress Monika, so if you’re half the man I think you are you’ll do great."
    t "I am, however, going to have to ask you to cancel the game."
    t "Mainly because the lesson is over in about two minutes."
    ...
    t "Alright, everyone, I’ll set today’s classwork as homework and we’ll pick up from there tomorrow!"
