label m_event2:
    ...
    scene bg h_corridor with wipeleft_scene
    ...
    show monika 1j at face with dissolve #<-- Would like to instead use a variant of e with eyes closed. Will create and substitute later
    ...
    scene bg downtown_1 with dissolve_scene_full
    ...
    menu:
        ...
        "Deviate towards the outskirts":
            ...
            jump outskirts
    label downtown:
        scene bg downtown_2 with wipeleft_scene
    ...
    label outskirts:
        scene bg downtown_3 with wipeleft_scene
    ...
    label e2c4join:
        scene bg downtown_1 with wipeleft_scene
        ...
        scene bg h_residential_sunset with dissolve_scene_full
        ...
        show monika 1bl at face with dissolve
        ...
        scene bg livingroom_sunset with open_eyes
        show monika 1be1 at face with dissolve
        ...
        stop music fadeout 2.0
        scene black with dissolve_scene_full
        scene bg livingroom_night with open_eyes
        ...
        scene bg clothingstore with wipeleft_scene
...
#C10
        ...
        menu:
            ...
            "Sure":
                ...
                if SayoriVar >= 1:
                    ...
                    scene bg schoolgate with wipeleft_scene
                    ...
                    show monika 1be at t11 with dissolve
        ...
        show monika 2bn at t11 with dissolve
...
#C11
    ...
    show monika 5a at t11 with dissolve
    mc "H-hey, Monika!"
    ...
    show monika 1j
    mc "That close?"
    show monika 2n at t11 with dissolve
    ...
    show monika 1e
    mc "Until club time."
    show monika 1j at t11 with dissolve
    pause .5
...
#C12
    ...
    show monika 1j at thide with dissolve
    hide monika
    ...
    show monika 1e1 at face with dissolve
...
#C13
    stop music fadeout 2.0
    scene bg bedroom_sunset with dissolve_scene_full
    play music tmonika
    ...
    scene bg downtown1_night with wipeleft_scene
    ...
    if dinnervar == 1:  #<-- Sapphire Star
        ...
        scene sastar with wipeleft_scene
        ...
        menu:
            ...
            "Stay Quiet":
                ...
                stop music fadeout 2.0
                scene bg downtown2_night with dissolve_scene_full
                play music t8
        ...
        scene bg downtown3_night with wipeleft_scene
        show monika 1dj at l11
        ...
        scene bg g55 with wipeleft_scene
        ...
        scene bg g55c with wipeleft_scene
        show monika 1dc at l11
        ...
        menu:
            ...
            "Get the meal":
                ...
                scene bg downtown2_night with dissolve
                show monika 1de at face with dissolve
            ...
            "Go with something cheaper":
                ...
                jump e2bad
label e2good:
    scene bg h_residential_night with dissolve_scene_full
    ...
    scene h_residential_night with open_eyes
    show monika 1de at face with dissolve
    ...
    ####
    show monika 1dj at t11 with dissolve
    ...
    scene bg h_livingroom_night with wipeleft_scene
    show monika 1dj at l11
    ...
    $ y_name = "Yuri"
    stop music fadeout 2.0
    jump m_event3 #<-- This will be used if we skip the lewd scene. If we do get the lewd scene comment out the jump here and use the lines below \/
